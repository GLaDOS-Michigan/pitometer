...
func (CompanionStruct_LReplicaConstants_) Create_LReplicaConstants_(My__index _dafny.Int, All LConstants) LReplicaConstants {
...
func (_this LReplicaConstants) Dtor_all() LConstants {
...
func (_this type_LReplicaConstants_) Default() interface{} {
	return LReplicaConstants{LReplicaConstants_LReplicaConstants{_dafny.Zero, Type_LConstants_().Default().(LConstants)}}
}
