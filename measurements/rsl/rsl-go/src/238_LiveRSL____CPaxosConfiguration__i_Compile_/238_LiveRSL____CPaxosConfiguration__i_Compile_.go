// Package _238_LiveRSL____CPaxosConfiguration__i_Compile
// Dafny module _238_LiveRSL____CPaxosConfiguration__i_Compile compiled into Go
...
// Definition of data type CPaxosConfiguration
type CPaxosConfiguration struct {
  Data_CPaxosConfiguration_
}

func (_this CPaxosConfiguration) Get() Data_CPaxosConfiguration_ {
  return _this.Data_CPaxosConfiguration_
}

type Data_CPaxosConfiguration_ interface {
  isCPaxosConfiguration()
}

type CompanionStruct_CPaxosConfiguration_ struct {}
var Companion_CPaxosConfiguration_ = CompanionStruct_CPaxosConfiguration_{}

type CPaxosConfiguration_CPaxosConfiguration struct {
  Replica__ids _dafny.Seq
}

func (CPaxosConfiguration_CPaxosConfiguration) isCPaxosConfiguration() {}

func (CompanionStruct_CPaxosConfiguration_) Create_CPaxosConfiguration_(Replica__ids _dafny.Seq) CPaxosConfiguration {
  return CPaxosConfiguration{CPaxosConfiguration_CPaxosConfiguration{Replica__ids}}
}

func (_this CPaxosConfiguration) Is_CPaxosConfiguration() bool {
  _, ok := _this.Get().(CPaxosConfiguration_CPaxosConfiguration)
return ok
}

func (_this CPaxosConfiguration) Dtor_replica__ids() _dafny.Seq {
  return _this.Get().(CPaxosConfiguration_CPaxosConfiguration).Replica__ids
}

func (_this CPaxosConfiguration) String() string {
  switch data := _this.Get().(type) {
    case nil: return "null"
case CPaxosConfiguration_CPaxosConfiguration: {
      return "_238_LiveRSL____CPaxosConfiguration__i_Compile.CPaxosConfiguration.CPaxosConfiguration" + "(" + _dafny.String(data.Replica__ids) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this CPaxosConfiguration) Equals(other CPaxosConfiguration) bool {
  switch data1 := _this.Get().(type) {
    case CPaxosConfiguration_CPaxosConfiguration: {
      data2, ok := other.Get().(CPaxosConfiguration_CPaxosConfiguration)
return ok && data1.Replica__ids.Equals(data2.Replica__ids)
    }
    default: {
...
func (_this CPaxosConfiguration) EqualsGeneric(other interface{}) bool {
  typed, ok := other.(CPaxosConfiguration)
return ok && _this.Equals(typed)
}
func Type_CPaxosConfiguration_() _dafny.Type {
  return type_CPaxosConfiguration_{}
}

type type_CPaxosConfiguration_ struct {
}

func (_this type_CPaxosConfiguration_) Default() interface{} {
  return CPaxosConfiguration{CPaxosConfiguration_CPaxosConfiguration{_dafny.EmptySeq}}
}

func (_this type_CPaxosConfiguration_) String() string {
  return "_238_LiveRSL____CPaxosConfiguration__i_Compile.CPaxosConfiguration"
}
// End of data type CPaxosConfiguration
...
func (*Default__) String() string {
  return "_238_LiveRSL____CPaxosConfiguration__i_Compile.Default__"
}
...
func (_this *CompanionStruct_Default___) PaxosEndPointIsValid(endPoint _9_Native____Io__s_Compile.EndPoint, config _238_LiveRSL____CPaxosConfiguration__i_Compile.CPaxosConfiguration) bool {
  return _180_Common____UdpClient__i_Compile.Companion_Default___.EndPointIsValidIPV4(endPoint)
}
func (_this *CompanionStruct_Default___) CGetReplicaIndex(replica _9_Native____Io__s_Compile.EndPoint, config _238_LiveRSL____CPaxosConfiguration__i_Compile.CPaxosConfiguration) (bool, uint64) {
...
var index uint64 = 0
  ...
  _4730_i = uint64(0)
  { }
  for (_4730_i) < (uint64(((config).Dtor_replica__ids()).CardinalityInt())) {
    if ((replica).Equals(((config).Dtor_replica__ids()).Index(_4730_i).(_9_Native____Io__s_Compile.EndPoint))) {
      found = true
      index = _4730_i
      { }
      { }
    ...
    if ((_4730_i) == ((uint64(((config).Dtor_replica__ids()).CardinalityInt())) - (func () uint64 { return  (uint64(1)) })())) {
      found = false
      return found,index
    }
    _4730_i = (_4730_i) + (uint64(1))
  }
  found = false
  return found,index
}
