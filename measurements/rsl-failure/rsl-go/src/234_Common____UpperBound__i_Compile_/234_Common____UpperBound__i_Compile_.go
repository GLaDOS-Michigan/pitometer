// Package _234_Common____UpperBound__i_Compile
// Dafny module _234_Common____UpperBound__i_Compile compiled into Go
...
func (*Default__) String() string {
  return "_234_Common____UpperBound__i_Compile.Default__"
}
...
func (_this *CompanionStruct_Default___) UpperBoundedAdditionImpl(x uint64, y uint64, u uint64) uint64 {
...
var sum uint64 = 0
  ...
  if ((y) >= (u)) {
    sum = u
  } else if ((x) >= ((u) - (func () uint64 { return  (y) })())) {
    sum = u
  } else {
    sum = (x) + (y)
  }
