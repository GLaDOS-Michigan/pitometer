...
_5245_end__time = _out424
  if (((broadcast).Is_CBroadcastNop()) || (((broadcast).Is_CBroadcast()) && ((uint64(((broadcast).Dtor_dsts()).CardinalityInt())) == (uint64(0))))) {
  ...
  } else if (((broadcast).Is_CBroadcast()) && ((uint64(((broadcast).Dtor_dsts()).CardinalityInt())) == (uint64(1)))) {
