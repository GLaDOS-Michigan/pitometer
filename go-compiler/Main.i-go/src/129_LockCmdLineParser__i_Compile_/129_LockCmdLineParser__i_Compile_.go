...
var index uint64 = 0
  ...
  var _ = _1739_i
  _1739_i = uint64(0)
  for (_1739_i) < (uint64((hosts).CardinalityInt())) {
    if ((host).Equals((hosts).Index(_1739_i).(_9_Native____Io__s_Compile.EndPoint))) {
      found = true
      index = _1739_i
      { }
      return found,index
    }
    if ((_1739_i) == ((uint64((hosts).CardinalityInt())) - (func () uint64 { return  (uint64(1)) })())) {
      found = false
      return found,index
    }
...
my__index = _out100
  ...
  var _ = _1746_me
  _1746_me = (_1743_endpoints).Index(my__index).(_9_Native____Io__s_Compile.EndPoint)
  { }
  { }
  { }
  { }
