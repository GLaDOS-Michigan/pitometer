...
var _out82 *_9_Native____Io__s_Compile.UdpClient
  var _ = _out82
_out81,_out82 = (_this).ConstructUdpClient((config).Index(my__index).(_9_Native____Io__s_Compile.EndPoint))
ok = _out81
...
(_this).Node = _out83
    { }
    (_this).LocalAddr = ((_this.Node).Dtor_config()).Index(my__index).(_9_Native____Io__s_Compile.EndPoint)
    { }
  }
  return ok
}
