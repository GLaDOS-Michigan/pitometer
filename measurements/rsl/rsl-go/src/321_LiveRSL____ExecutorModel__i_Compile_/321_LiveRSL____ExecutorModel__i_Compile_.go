...
var replies__seq _dafny.Seq = _dafny.EmptySeq
  ...
  var _nw11 = _dafny.NewArrayWithValue(_214_LiveRSL____CTypes__i_Compile.Type_CReply_().Default().(_214_LiveRSL____CTypes__i_Compile.CReply), uint64((batch).CardinalityInt()))
  var _ = _nw11
  _5010_repliesArr = _nw11
  { }
  for (_5009_i) < (uint64((batch).CardinalityInt())) {
    { }
    { }
    { }
...
var _out228 _197_LiveRSL____AppInterface__i_Compile.CAppMessage
    var _ = _out228
_out227,_out228 = _197_LiveRSL____AppInterface__i_Compile.Companion_Default___.HandleAppRequest(final__state, ((batch).Index(_5009_i).(_214_LiveRSL____CTypes__i_Compile.CRequest)).Dtor_request())
_5011_new__state = _out227
_5012_reply = _out228
    var _5013_newReply _214_LiveRSL____CTypes__i_Compile.CReply
    var _ = _5013_newReply
    _5013_newReply = _214_LiveRSL____CTypes__i_Compile.CReply{_214_LiveRSL____CTypes__i_Compile.CReply_CReply{((batch).Index(_5009_i).(_214_LiveRSL____CTypes__i_Compile.CRequest)).Dtor_client(), ((batch).Index(_5009_i).(_214_LiveRSL____CTypes__i_Compile.CRequest)).Dtor_seqno(), _5012_reply}}
    { }
    *((_5010_repliesArr).Index(_dafny.IntOfAny((_5009_i)))) = _5013_newReply
    { }
    final__state = _5011_new__state
    Companion_Default___.UpdateReplyCache(reply__cache__mutable, ((batch).Index(_5009_i).(_214_LiveRSL____CTypes__i_Compile.CRequest)).Dtor_client(), _5013_newReply, _5012_reply, _5009_i, batch)
...
func (_this *CompanionStruct_Default___) GetPacketsFromRepliesImpl(me _9_Native____Io__s_Compile.EndPoint, requests _dafny.Seq, replies _dafny.Seq) _dafny.Seq {
  ...
  var _ = _5020_coutArr
  var _nw12 = _dafny.NewArrayWithValue(_217_LiveRSL____CMessage__i_Compile.Type_CPacket_().Default().(_217_LiveRSL____CMessage__i_Compile.CPacket), uint64((replies).CardinalityInt()))
  var _ = _nw12
  _5020_coutArr = _nw12
  for (_5019_i) < (uint64((replies).CardinalityInt())) {
    { }
    var _5021_cmsg _217_LiveRSL____CMessage__i_Compile.CMessage
    var _ = _5021_cmsg
    _5021_cmsg = _217_LiveRSL____CMessage__i_Compile.CMessage{_217_LiveRSL____CMessage__i_Compile.CMessage_CMessage__Reply{((requests).Index(_5019_i).(_214_LiveRSL____CTypes__i_Compile.CRequest)).Dtor_seqno(), ((replies).Index(_5019_i).(_214_LiveRSL____CTypes__i_Compile.CReply)).Dtor_reply()}}
    var _5022_cp _217_LiveRSL____CMessage__i_Compile.CPacket
    var _ = _5022_cp
    _5022_cp = _217_LiveRSL____CMessage__i_Compile.CPacket{_217_LiveRSL____CMessage__i_Compile.CPacket_CPacket{((requests).Index(_5019_i).(_214_LiveRSL____CTypes__i_Compile.CRequest)).Dtor_client(), me, _5021_cmsg}}
    { }
...
_5027_end__time__request__batch = _out235
  ...
  _5028_newMaxBalReflected = (func () _214_LiveRSL____CTypes__i_Compile.CBallot { if _214_LiveRSL____CTypes__i_Compile.Companion_Default___.CBallotIsNotGreaterThan((cs).Dtor_max__bal__reflected(), ((cs).Dtor_next__op__to__execute()).Dtor_bal()) { return ((cs).Dtor_next__op__to__execute()).Dtor_bal() }; return (cs).Dtor_max__bal__reflected() })() 
  ...
  var _ = _5035_cme
  _5035_cme = (((((cs).Dtor_constants()).Dtor_all()).Dtor_config()).Dtor_replica__ids()).Index(((cs).Dtor_constants()).Dtor_my__index()).(_9_Native____Io__s_Compile.EndPoint)
  { }
  { }
  { }
  { }
...
var cout _217_LiveRSL____CMessage__i_Compile.OutboundPackets = _217_LiveRSL____CMessage__i_Compile.Type_OutboundPackets_().Default().(_217_LiveRSL____CMessage__i_Compile.OutboundPackets)
  ...
  if ((((((((cs).Dtor_constants()).Dtor_all()).Dtor_config()).Dtor_replica__ids()).Contains((cinp).Dtor_src())) && (_214_LiveRSL____CTypes__i_Compile.Companion_Default___.CBallotIsNotGreaterThan((cs).Dtor_max__bal__reflected(), ((cinp).Dtor_msg()).Dtor_bal__state__req()))) && ((((cs).Dtor_ops__complete()).Dtor_n()) >= ((((cinp).Dtor_msg()).Dtor_opn__state__req()).Dtor_n()))) {
    ...
    var _ = _5045_cme
    _5045_cme = (((((cs).Dtor_constants()).Dtor_all()).Dtor_config()).Dtor_replica__ids()).Index(((cs).Dtor_constants()).Dtor_my__index()).(_9_Native____Io__s_Compile.EndPoint)
...
_5053_cachedReply = _out245.(_214_LiveRSL____CTypes__i_Compile.CReply)
  ...
  if ((((cinp).Dtor_msg()).Dtor_seqno()) == ((_5053_cachedReply).Dtor_seqno())) {
    ...
    cout = _217_LiveRSL____CMessage__i_Compile.OutboundPackets{_217_LiveRSL____CMessage__i_Compile.OutboundPackets_OutboundPacket{_135_Logic____Option__i_Compile.Option{_135_Logic____Option__i_Compile.Option_Some{_217_LiveRSL____CMessage__i_Compile.CPacket{_217_LiveRSL____CMessage__i_Compile.CPacket_CPacket{(_5054_cr).Dtor_client(), (((((cs).Dtor_constants()).Dtor_all()).Dtor_config()).Dtor_replica__ids()).Index(((cs).Dtor_constants()).Dtor_my__index()).(_9_Native____Io__s_Compile.EndPoint), _5055_msg}}}}}}
    { }
  } else {
    cout = _217_LiveRSL____CMessage__i_Compile.OutboundPackets{_217_LiveRSL____CMessage__i_Compile.OutboundPackets_OutboundPacket{_135_Logic____Option__i_Compile.Option{_135_Logic____Option__i_Compile.Option_None{}}}}
  }
