...
TAIL_CALL_START:
  ...
  var _ = _4533_i
  _4533_i = uint64(0)
  for (_4533_i) < (uint64((s).CardinalityInt())) {
    *((a).Index(_dafny.IntOfAny((_4533_i)))) = (s).Index(_4533_i).(interface{})
...
var a *_dafny.Array = _dafny.NewArrayWithValue(Type_A_.Default(), _dafny.IntOf(0))
  var _ = a
  var _nw1 = _dafny.NewArrayWithValue(Type_A_.Default(), uint64((s).CardinalityInt()))
  var _ = _nw1
  a = _nw1
...
TAIL_CALL_START:
  ...
  var _ = _4534_i
  _4534_i = uint64(0)
  for (_4534_i) < (uint64((s).CardinalityInt())) {
    *((a).Index(_dafny.IntOfAny((_4534_i)))) = (s).Index(_4534_i).(_dafny.Char)
...
func (_this *CompanionStruct_Default___) SeqByteToUint64(bs _dafny.Seq) uint64 {
  return (((((((((((uint64((bs).Index(uint64(0)).(uint8))) * (uint64(256))) * (uint64(256))) * (uint64(256))) * (uint64(4294967296))) + ((((uint64((bs).Index(uint64(1)).(uint8))) * (uint64(256))) * (uint64(256))) * (uint64(4294967296)))) + (((uint64((bs).Index(uint64(2)).(uint8))) * (uint64(256))) * (uint64(4294967296)))) + ((uint64((bs).Index(uint64(3)).(uint8))) * (uint64(4294967296)))) + ((((uint64((bs).Index(uint64(4)).(uint8))) * (uint64(256))) * (uint64(256))) * (uint64(256)))) + (((uint64((bs).Index(uint64(5)).(uint8))) * (uint64(256))) * (uint64(256)))) + ((uint64((bs).Index(uint64(6)).(uint8))) * (uint64(256)))) + (uint64((bs).Index(uint64(7)).(uint8)))
}
...
func (_this *CompanionStruct_Default___) SeqByteToUint16(bs _dafny.Seq) uint16 {
  return ((uint16((bs).Index(uint64(0)).(uint8))) * (uint16(256))) + (uint16((bs).Index(uint64(1)).(uint8)))
}
