// Package _479_DirectRefinement____StateMachine__i_Compile
// Dafny module _479_DirectRefinement____StateMachine__i_Compile compiled into Go
...
// Definition of data type RSLSystemState
type RSLSystemState struct {
  Data_RSLSystemState_
}

func (_this RSLSystemState) Get() Data_RSLSystemState_ {
  return _this.Data_RSLSystemState_
}

type Data_RSLSystemState_ interface {
  isRSLSystemState()
}

type CompanionStruct_RSLSystemState_ struct {}
var Companion_RSLSystemState_ = CompanionStruct_RSLSystemState_{}

type RSLSystemState_RSLSystemState struct {
  Server__addresses _dafny.Set
App uint64
Requests _dafny.Set
Replies _dafny.Set
}

func (RSLSystemState_RSLSystemState) isRSLSystemState() {}

func (CompanionStruct_RSLSystemState_) Create_RSLSystemState_(Server__addresses _dafny.Set, App uint64, Requests _dafny.Set, Replies _dafny.Set) RSLSystemState {
  return RSLSystemState{RSLSystemState_RSLSystemState{Server__addresses,App,Requests,Replies}}
}

func (_this RSLSystemState) Is_RSLSystemState() bool {
  _, ok := _this.Get().(RSLSystemState_RSLSystemState)
return ok
}

func (_this RSLSystemState) Dtor_server__addresses() _dafny.Set {
  return _this.Get().(RSLSystemState_RSLSystemState).Server__addresses
}

func (_this RSLSystemState) Dtor_app() uint64 {
  return _this.Get().(RSLSystemState_RSLSystemState).App
}

func (_this RSLSystemState) Dtor_requests() _dafny.Set {
  return _this.Get().(RSLSystemState_RSLSystemState).Requests
}

func (_this RSLSystemState) Dtor_replies() _dafny.Set {
  return _this.Get().(RSLSystemState_RSLSystemState).Replies
}

func (_this RSLSystemState) String() string {
  switch data := _this.Get().(type) {
    case nil: return "null"
case RSLSystemState_RSLSystemState: {
      return "_479_DirectRefinement____StateMachine__i_Compile.RSLSystemState.RSLSystemState" + "(" + _dafny.String(data.Server__addresses) + ", " + _dafny.String(data.App) + ", " + _dafny.String(data.Requests) + ", " + _dafny.String(data.Replies) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this RSLSystemState) Equals(other RSLSystemState) bool {
  switch data1 := _this.Get().(type) {
    case RSLSystemState_RSLSystemState: {
      data2, ok := other.Get().(RSLSystemState_RSLSystemState)
return ok && data1.Server__addresses.Equals(data2.Server__addresses) && data1.App == data2.App && data1.Requests.Equals(data2.Requests) && data1.Replies.Equals(data2.Replies)
    }
    default: {
...
func (_this RSLSystemState) EqualsGeneric(other interface{}) bool {
  typed, ok := other.(RSLSystemState)
return ok && _this.Equals(typed)
}
func Type_RSLSystemState_() _dafny.Type {
  return type_RSLSystemState_{}
}

type type_RSLSystemState_ struct {
}

func (_this type_RSLSystemState_) Default() interface{} {
  return RSLSystemState{RSLSystemState_RSLSystemState{_dafny.EmptySet, 0, _dafny.EmptySet, _dafny.EmptySet}}
}

func (_this type_RSLSystemState_) String() string {
  return "_479_DirectRefinement____StateMachine__i_Compile.RSLSystemState"
}
// End of data type RSLSystemState
