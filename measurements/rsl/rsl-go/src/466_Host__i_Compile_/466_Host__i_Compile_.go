...
case CScheduler_CScheduler: {
      return "_466_Host__i_Compile.CScheduler.CScheduler" + "(" + _dafny.String(data.Replica__impl) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this type_CScheduler_) String() string {
  return "_466_Host__i_Compile.CScheduler"
}
...
func (*Default__) String() string {
  return "_466_Host__i_Compile.Default__"
}
...
func (_this *CompanionStruct_Default___) HostInitImpl() (bool, _466_Host__i_Compile.CScheduler, _240_LiveRSL____ConstantsState__i_Compile.ConstantsState, _9_Native____Io__s_Compile.EndPoint) {
  var ok bool = false
  var _ = ok
var host__state _466_Host__i_Compile.CScheduler = Type_CScheduler_().Default().(_466_Host__i_Compile.CScheduler)
  var _ = host__state
...
_nw16.Ctor__()
  ...
  { }
  id = ((_5334_pconfig).Dtor_replica__ids()).Index(_5335_my__index).(_9_Native____Io__s_Compile.EndPoint)
...
func (_this *CompanionStruct_Default___) HostNextImpl(host__state _466_Host__i_Compile.CScheduler) (bool, _466_Host__i_Compile.CScheduler) {
  var ok bool = false
  var _ = ok
var host__state_k _466_Host__i_Compile.CScheduler = Type_CScheduler_().Default().(_466_Host__i_Compile.CScheduler)
  var _ = host__state_k
