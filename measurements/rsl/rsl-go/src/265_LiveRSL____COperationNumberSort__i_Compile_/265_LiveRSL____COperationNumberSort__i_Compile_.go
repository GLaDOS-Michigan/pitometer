// Package _265_LiveRSL____COperationNumberSort__i_Compile
// Dafny module _265_LiveRSL____COperationNumberSort__i_Compile compiled into Go
...
func (*Default__) String() string {
	return "_265_LiveRSL____COperationNumberSort__i_Compile.Default__"
}
...
func (_this *CompanionStruct_Default___) InsertionSortCOperationNumbers(a *_dafny.Array) {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (uint64((a).LenInt(0))) == (uint64(0)) {
		return
	}
	var _4737_i uint64
	var _ = _4737_i
	_4737_i = uint64(1)
	for (_4737_i) < (uint64((a).LenInt(0))) {
		var _4738_j uint64
		var _ = _4738_j
		_4738_j = _4737_i
		for ((uint64(0)) < (_4738_j)) && ((((*(a).IndexUints(((_4738_j) - (func() uint64 { return (uint64(1)) })()))).(_214_LiveRSL____CTypes__i_Compile.COperationNumber)).Dtor_n()) > (((*(a).IndexUints((_4738_j))).(_214_LiveRSL____CTypes__i_Compile.COperationNumber)).Dtor_n())) {
			var _index8 = (_4738_j) - (func() uint64 { return (uint64(1)) })()
			var _ = _index8
			*((a).Index(_dafny.IntOfAny((_4738_j)))), *((a).Index(_dafny.IntOfAny(_index8))) = (*(a).IndexUints(((_4738_j) - (func() uint64 { return (uint64(1)) })()))).(_214_LiveRSL____CTypes__i_Compile.COperationNumber), (*(a).IndexUints((_4738_j))).(_214_LiveRSL____CTypes__i_Compile.COperationNumber)
			_4738_j = (_4738_j) - (func() uint64 { return (uint64(1)) })()
		}
		_4737_i = (_4737_i) + (uint64(1))
	}
	{
	}
}
