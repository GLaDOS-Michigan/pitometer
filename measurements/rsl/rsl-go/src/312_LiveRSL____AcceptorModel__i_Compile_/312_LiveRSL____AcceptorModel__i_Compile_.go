...
var packets__sent _217_LiveRSL____CMessage__i_Compile.CBroadcast = _217_LiveRSL____CMessage__i_Compile.Type_CBroadcast_().Default().(_217_LiveRSL____CMessage__i_Compile.CBroadcast)
  ...
  packets__sent = _217_LiveRSL____CMessage__i_Compile.CBroadcast{_217_LiveRSL____CMessage__i_Compile.CBroadcast_CBroadcast{(((((acceptor).Dtor_constants()).Dtor_all()).Dtor_config()).Dtor_replica__ids()).Index(((acceptor).Dtor_constants()).Dtor_my__index()).(_9_Native____Io__s_Compile.EndPoint), _dafny.SeqOf(sender), _4947_outMsg}}
...
_4972_index = _out223
  ...
  { }
  if ((((in__msg).Dtor_opn__ckpt()).Dtor_n()) <= ((((acceptor).Dtor_last__checkpointed__operation()).Index(_4972_index).(_214_LiveRSL____CTypes__i_Compile.COperationNumber)).Dtor_n())) {
    return acceptor_k
  }
  ...
  var _ = _4974_newLCO
  _4974_newLCO = ((acceptor).Dtor_last__checkpointed__operation()).Update(_dafny.IntOfUint64(_4972_index), (in__msg).Dtor_opn__ckpt())
