...
var sent__packets _217_LiveRSL____CMessage__i_Compile.CBroadcast = _217_LiveRSL____CMessage__i_Compile.Type_CBroadcast_().Default().(_217_LiveRSL____CMessage__i_Compile.CBroadcast)
  ...
  _4875_batchSize = (func () _dafny.Int { if ((((proposer).Dtor_request__queue()).Cardinality()).Cmp(_dafny.IntOfUint64(((((proposer).Dtor_constants()).Dtor_all()).Dtor_params()).Dtor_max__batch__size())) <= 0) || ((((((proposer).Dtor_constants()).Dtor_all()).Dtor_params()).Dtor_max__batch__size()) < (uint64(0))) { return ((proposer).Dtor_request__queue()).Cardinality() }; return _dafny.IntOfUint64(((((proposer).Dtor_constants()).Dtor_all()).Dtor_params()).Dtor_max__batch__size()) })() 
...
_4879_clock__sum = _out186
  ...
  _4880_newTimer = (func () _254_LiveRSL____ProposerState__i_Compile.CIncompleteBatchTimer { if (((proposer).Dtor_request__queue()).Cardinality()).Cmp(_4875_batchSize) > 0 { return _254_LiveRSL____ProposerState__i_Compile.CIncompleteBatchTimer{_254_LiveRSL____ProposerState__i_Compile.CIncompleteBatchTimer_CIncompleteBatchTimerOn{_4879_clock__sum}} }; return _254_LiveRSL____ProposerState__i_Compile.CIncompleteBatchTimer{_254_LiveRSL____ProposerState__i_Compile.CIncompleteBatchTimer_CIncompleteBatchTimerOff{}} })() 
