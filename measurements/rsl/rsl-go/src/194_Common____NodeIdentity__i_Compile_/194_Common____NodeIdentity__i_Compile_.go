...
func (_this *CompanionStruct_Default___) ConvertSeqByteToEndPoint(s _dafny.Seq) _9_Native____Io__s_Compile.EndPoint {
  return _9_Native____Io__s_Compile.EndPoint{_9_Native____Io__s_Compile.EndPoint_EndPoint{(s).Subseq(uint64(2), uint64(6)), _170_Common____Util__i_Compile.Companion_Default___.SeqByteToUint16((s).Subseq(uint64(6), _dafny.NilInt))}}
}
