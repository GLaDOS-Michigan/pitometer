...
type LIoOp_LIoOpSend struct {
  S _7_Environment__s_Compile.LPacket
}

func (LIoOp_LIoOpSend) isLIoOp() {}

func (CompanionStruct_LIoOp_) Create_LIoOpSend_(S _7_Environment__s_Compile.LPacket) LIoOp {
...
type LIoOp_LIoOpReceive struct {
  R _7_Environment__s_Compile.LPacket
}

func (LIoOp_LIoOpReceive) isLIoOp() {}

func (CompanionStruct_LIoOp_) Create_LIoOpReceive_(R _7_Environment__s_Compile.LPacket) LIoOp {
...
func (_this LIoOp) Dtor_s() _7_Environment__s_Compile.LPacket {
  return _this.Get().(LIoOp_LIoOpSend).S
}

func (_this LIoOp) Dtor_r() _7_Environment__s_Compile.LPacket {
...
func (CompanionStruct_LEnvStep_) Create_LEnvStepHostIos_(Actor interface{}, Ios _dafny.Seq) LEnvStep {
  return LEnvStep{LEnvStep_LEnvStepHostIos{Actor,Ios}}
}
...
type LEnvStep_LEnvStepDeliverPacket struct {
  P _7_Environment__s_Compile.LPacket
}

func (LEnvStep_LEnvStepDeliverPacket) isLEnvStep() {}

func (CompanionStruct_LEnvStep_) Create_LEnvStepDeliverPacket_(P _7_Environment__s_Compile.LPacket) LEnvStep {
...
func (_this LEnvStep) Dtor_p() _7_Environment__s_Compile.LPacket {
...
case LEnvStep_LEnvStepHostIos: {
      return "_7_Environment__s_Compile.LEnvStep.LEnvStepHostIos" + "(" + _dafny.String(data.Actor) + ", " + _dafny.String(data.Ios) + ")"
    }
...
return ok && _dafny.AreEqual(data1.Actor, data2.Actor) && data1.Ios.Equals(data2.Ios)
    }
    case LEnvStep_LEnvStepDeliverPacket: {
...
HostInfo _dafny.Map
NextStep _7_Environment__s_Compile.LEnvStep
}

func (LEnvironment_LEnvironment) isLEnvironment() {}

func (CompanionStruct_LEnvironment_) Create_LEnvironment_(Time _dafny.Int, SentPackets _dafny.Set, HostInfo _dafny.Map, NextStep _7_Environment__s_Compile.LEnvStep) LEnvironment {
...
func (_this LEnvironment) Dtor_nextStep() _7_Environment__s_Compile.LEnvStep {
...
func (_this type_LEnvironment_) Default() interface{} {
  return LEnvironment{LEnvironment_LEnvironment{_dafny.Zero, _dafny.EmptySet, _dafny.EmptyMap, Type_LEnvStep_().Default().(_7_Environment__s_Compile.LEnvStep)}}
}
