// Package _54_Native____NativeTypes__i_Compile
// Dafny module _54_Native____NativeTypes__i_Compile compiled into Go
...
func (*Default__) String() string {
  return "_54_Native____NativeTypes__i_Compile.Default__"
}
