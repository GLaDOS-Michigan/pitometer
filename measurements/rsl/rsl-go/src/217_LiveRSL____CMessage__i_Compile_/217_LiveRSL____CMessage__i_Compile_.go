...
func (_this CMessage) String() string {
	...
	case CMessage_CMessage__Invalid:
		{
			return "CMessage.CMessage_Invalid"
		}
	case CMessage_CMessage__Request:
		{
			return "CMessage.CMessage_Request" + "(" + _dafny.String(data.Seqno) + ", " + _dafny.String(data.Val) + ")"
		}
	case CMessage_CMessage__1a:
		{
			return "CMessage.CMessage_1a" + "(" + _dafny.String(data.Bal__1a) + ")"
		}
	case CMessage_CMessage__1b:
		{
			return "CMessage.CMessage_1b" + "(" + _dafny.String(data.Bal__1b) + ", " + _dafny.String(data.Log__truncation__point) + ", " + _dafny.String(data.Votes) + ")"
		}
	case CMessage_CMessage__2a:
		{
			return "CMessage.CMessage_2a" + "(" + _dafny.String(data.Bal__2a) + ", " + _dafny.String(data.Opn__2a) + ", " + _dafny.String(data.Val__2a) + ")"
		}
	case CMessage_CMessage__2b:
		{
			return "CMessage.CMessage_2b" + "(" + _dafny.String(data.Bal__2b) + ", " + _dafny.String(data.Opn__2b) + ", " + _dafny.String(data.Val__2b) + ")"
		}
	case CMessage_CMessage__Heartbeat:
		{
			return "CMessage.CMessage_Heartbeat" + "(" + _dafny.String(data.Bal__heartbeat) + ", " + _dafny.String(data.Suspicious) + ", " + _dafny.String(data.Opn__ckpt) + ")"
		}
	case CMessage_CMessage__Reply:
		{
			return "CMessage.CMessage_Reply" + "(" + _dafny.String(data.Seqno__reply) + ", " + _dafny.String(data.Reply) + ")"
		}
	case CMessage_CMessage__AppStateRequest:
		{
			return "CMessage.CMessage_AppStateRequest" + "(" + _dafny.String(data.Bal__state__req) + ", " + _dafny.String(data.Opn__state__req) + ")"
		}
	case CMessage_CMessage__AppStateSupply:
		{
			return "CMessage.CMessage_AppStateSupply" + "(" + _dafny.String(data.Bal__state__supply) + ", " + _dafny.String(data.Opn__state__supply) + ", " + _dafny.String(data.App__state) + ", " + _dafny.String(data.Reply__cache) + ")"
		}
	case CMessage_CMessage__StartingPhase2:
		{
			return "CMessage.CMessage_StartingPhase2" + "(" + _dafny.String(data.Bal__2) + ", " + _dafny.String(data.LogTruncationPoint__2) + ")"
		}
	default:
		{
			return "<unexpected>"
...
func (CompanionStruct_CPacket_) Create_CPacket_(Dst _9_Native____Io__s_Compile.EndPoint, Src _9_Native____Io__s_Compile.EndPoint, Msg CMessage) CPacket {
...
func (_this CPacket) Dtor_msg() CMessage {
...
func (_this CPacket) String() string {
	...
	case CPacket_CPacket:
		{
			return "CPacket.CPacket" + "(" + _dafny.String(data.Dst) + ", " + _dafny.String(data.Src) + ", " + _dafny.String(data.Msg) + ")"
		}
	default:
		{
			return "<unexpected>"
...
func (_this type_CPacket_) Default() interface{} {
	return CPacket{CPacket_CPacket{_9_Native____Io__s_Compile.Type_EndPoint_().Default().(_9_Native____Io__s_Compile.EndPoint), _9_Native____Io__s_Compile.Type_EndPoint_().Default().(_9_Native____Io__s_Compile.EndPoint), Type_CMessage_().Default().(CMessage)}}
}
...
func (CompanionStruct_CBroadcast_) Create_CBroadcast_(Src _9_Native____Io__s_Compile.EndPoint, Dsts _dafny.Seq, Msg CMessage) CBroadcast {
...
func (_this CBroadcast) Dtor_msg() CMessage {
...
func (_this CBroadcast) String() string {
	...
	case CBroadcast_CBroadcast:
		{
			return "CBroadcast.CBroadcast" + "(" + _dafny.String(data.Src) + ", " + _dafny.String(data.Dsts) + ", " + _dafny.String(data.Msg) + ")"
		}
	case CBroadcast_CBroadcastNop:
		{
			return "CBroadcast.CBroadcastNop"
		}
	default:
		{
			return "<unexpected>"
...
func (_this type_CBroadcast_) Default() interface{} {
	return CBroadcast{CBroadcast_CBroadcast{_9_Native____Io__s_Compile.Type_EndPoint_().Default().(_9_Native____Io__s_Compile.EndPoint), _dafny.EmptySeq, Type_CMessage_().Default().(CMessage)}}
}
...
func (CompanionStruct_OutboundPackets_) Create_Broadcast_(Broadcast CBroadcast) OutboundPackets {
...
func (_this OutboundPackets) Dtor_broadcast() CBroadcast {
...
func (_this OutboundPackets) String() string {
	...
	case OutboundPackets_Broadcast:
		{
			return "OutboundPackets.Broadcast" + "(" + _dafny.String(data.Broadcast) + ")"
		}
	case OutboundPackets_OutboundPacket:
		{
			return "OutboundPackets.OutboundPacket" + "(" + _dafny.String(data.P) + ")"
		}
	case OutboundPackets_PacketSequence:
		{
			return "OutboundPackets.PacketSequence" + "(" + _dafny.String(data.S) + ")"
		}
	default:
		{
			return "<unexpected>"
...
func (_this type_OutboundPackets_) Default() interface{} {
	return OutboundPackets{OutboundPackets_Broadcast{Type_CBroadcast_().Default().(CBroadcast)}}
}
