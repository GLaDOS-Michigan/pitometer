...
// Dafny 2.3.0.10506
// Command Line Options: /noCheating:1 /proverWarnings:1 /z3opt:pi.warnings=true /allowGlobals /ironDafny /warnShadowing /z3opt:nlsat.randomize=false /autoTriggers:1 /noNLarith /timeLimit:30 /noVerify /compile:1 /spillTargetCode:3 Main.i.dfy
// Main.i.dfy
  ...
  public partial class __default {
    public static Dafny.Set<U> domain<U,V>(Dafny.Map<U,V> m) {
      return ((System.Func<Dafny.Set<U>>)(() => {
        ...
        foreach (var _compr_0 in (m).Keys.Elements) { U _1416_s = (U)_compr_0;
          if ((m).Contains(_1416_s)) {
            _coll0.Add(_1416_s);
          }
        }
    ...
    {
      Dafny.Map<U,V> _1417_m_k = ((System.Func<Dafny.Map<U,V>>)(() => {
        var _coll1 = new System.Collections.Generic.List<Dafny.Pair<U,V>>();
        foreach (var _1418_elt_k in (m).Keys.Elements) {
          if (((m).Contains(_1418_elt_k)) && (!(_1418_elt_k).Equals(elt))) {
            _coll1.Add(new Dafny.Pair<U,V>(_1418_elt_k,(m).Select(_1418_elt_k)));
          }
        }
...
namespace _101_Common____Util__i_Compile {
  ...
  public partial class __default {
    ...
    TAIL_CALL_START: ;
      a = new A[0];
      BigInteger _1419_len;
      _1419_len = new BigInteger((s).Count);
      var _nw0 = Dafny.ArrayHelpers.InitNewArray1<A>(Dafny.Helpers.Default<A>(), (_1419_len));
      a = _nw0;
      BigInteger _1420_i;
      _1420_i = new BigInteger(0);
      while ((_1420_i) < (_1419_len)) {
        (a)[(int)((_1420_i))] = (s).Select(_1420_i);
        _1420_i = (_1420_i) + (new BigInteger(1));
      }
    }
    ...
    TAIL_CALL_START: ;
      ulong _1421_i;
      _1421_i = 0UL;
      while ((_1421_i) < ((ulong)(s).LongCount)) {
        (a)[(int)((_1421_i))] = (s).Select(_1421_i);
        _1421_i = (_1421_i) + (1UL);
      }
    }
    ...
    TAIL_CALL_START: ;
      ulong _1422_i;
      _1422_i = 0UL;
      while ((_1422_i) < ((ulong)(s).LongCount)) {
        (a)[(int)((_1422_i))] = (s).Select(_1422_i);
        _1422_i = (_1422_i) + (1UL);
      }
    }
    ...
    {
    TAIL_CALL_START: ;
      char[] _1423_name__array;
      var _nw2 = new char[(int)(new BigInteger((name).Count))];
      _1423_name__array = _nw2;
      _101_Common____Util__i_Compile.__default.seqIntoArrayChar(name, _1423_name__array);
      ulong _1424_time = 0;
      if ((start) <= (end)) {
        _1424_time = (end) - (start);
      } else {
        _1424_time = 18446744073709551615UL;
      }
      _9_Native____Io__s_Compile.Time.RecordTiming(_1423_name__array, _1424_time);
    }
    ...
    public static Dafny.Sequence<byte> Uint64ToSeqByte(ulong u) {
      Dafny.Sequence<byte> _1425_bs = Dafny.Sequence<byte>.FromElements((byte)((u) / (72057594037927936UL)), (byte)(((u) / (281474976710656UL)) % (256UL)), (byte)(((u) / (1099511627776UL)) % (256UL)), (byte)(((u) / (4294967296UL)) % (256UL)), (byte)(((u) / (16777216UL)) % (256UL)), (byte)(((u) / (65536UL)) % (256UL)), (byte)(((u) / (256UL)) % (256UL)), (byte)((u) % (256UL)));
      BigInteger _1426_u__int = new BigInteger(u);
      return _1425_bs;
    }
    ...
    public static Dafny.Sequence<byte> Uint16ToSeqByte(ushort u) {
      Dafny.Sequence<byte> _1427_s = Dafny.Sequence<byte>.FromElements((byte)((ushort)(((ushort)((u) / (256))) % (256))), (byte)((ushort)((u) % (256))));
      BigInteger _1428_u__int = new BigInteger(u);
      return _1427_s;
    }
  }
  ...
  public partial class __default {
    ...
    public static _System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>> parse__Array__contents(Dafny.Sequence<byte> data, _107_Common____GenericMarshalling__i_Compile.G eltType, ulong len)
    {
      if ((len) == (0UL)) {
        ...
        _44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V> _1430_val = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>)_let_tmp_rhs0)._0;
        Dafny.Sequence<byte> _1431_rest1 = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>)_let_tmp_rhs0)._1;
        _System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>> _let_tmp_rhs1 = _107_Common____GenericMarshalling__i_Compile.__default.parse__Array__contents(_1431_rest1, eltType, (len) - (1UL));
        _44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>> _1432_others = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>>)_let_tmp_rhs1)._0;
        Dafny.Sequence<byte> _1433_rest2 = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>>)_let_tmp_rhs1)._1;
        if ((!((_1430_val).is_None)) && (!((_1432_others).is_None))) {
          return @_System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>>.create(@_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>.create_Some((Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>.FromElements((_1430_val).dtor_v)).Concat((_1432_others).dtor_v)), _1433_rest2);
        } else  {
    ...
    public static void ParseArrayContents(byte[] data, ulong index, _107_Common____GenericMarshalling__i_Compile.G eltType, ulong len, out bool success, out Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V> v, out ulong rest__index)
    {
      ...
      rest__index = 0;
      { }
      _107_Common____GenericMarshalling__i_Compile.V[] _1434_vArr;
      ...
      ulong _1435_i;
      _1435_i = 0UL;
      ulong _1436_next__val__index;
      _1436_next__val__index = index;
      { }
      while ((_1435_i) < (len)) {
        bool _1437_some1;
        _107_Common____GenericMarshalling__i_Compile.V _1438_val;
        ulong _1439_rest1;
        bool _out0;
        _107_Common____GenericMarshalling__i_Compile.V _out1;
        ulong _out2;
        _107_Common____GenericMarshalling__i_Compile.__default.ParseVal(data, _1436_next__val__index, eltType, out _out0, out _out1, out _out2);
        _1437_some1 = _out0;
        _1438_val = _out1;
        _1439_rest1 = _out2;
        { }
        ...
        { }
        (_1434_vArr)[(int)((_1435_i))] = _1438_val;
        _1436_next__val__index = _1439_rest1;
        _1435_i = (_1435_i) + (1UL);
      }
      success = true;
      rest__index = _1436_next__val__index;
      v = Dafny.Helpers.SeqFromArray(_1434_vArr);
      { }
    }
    public static _System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>> parse__Array(Dafny.Sequence<byte> data, _107_Common____GenericMarshalling__i_Compile.G eltType)
    {
      ...
      _44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V> _1440_len = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>)_let_tmp_rhs2)._0;
      Dafny.Sequence<byte> _1441_rest = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>)_let_tmp_rhs2)._1;
      if (!((_1440_len).is_None)) {
        _System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>> _let_tmp_rhs3 = _107_Common____GenericMarshalling__i_Compile.__default.parse__Array__contents(_1441_rest, eltType, ((_1440_len).dtor_v).dtor_u);
        _44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>> _1442_contents = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>>)_let_tmp_rhs3)._0;
        Dafny.Sequence<byte> _1443_remainder = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>>)_let_tmp_rhs3)._1;
        if (!((_1442_contents).is_None)) {
          return @_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>.create(@_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>.create_Some(@_107_Common____GenericMarshalling__i_Compile.V.create_VArray((_1442_contents).dtor_v)), _1443_remainder);
        } else  {
          return @_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>.create(@_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>.create_None(), Dafny.Sequence<byte>.FromElements());
        }
      } else  {
    ...
    public static void ParseArray(byte[] data, ulong index, _107_Common____GenericMarshalling__i_Compile.G eltType, out bool success, out _107_Common____GenericMarshalling__i_Compile.V v, out ulong rest__index)
    {
      ...
      rest__index = 0;
      bool _1444_some1;
      _107_Common____GenericMarshalling__i_Compile.V _1445_len;
      ulong _1446_rest;
      bool _out3;
      ...
      if (_1444_some1) {
        bool _1447_some2;
        Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V> _1448_contents;
        ulong _1449_remainder;
        bool _out6;
        Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V> _out7;
        ulong _out8;
        _107_Common____GenericMarshalling__i_Compile.__default.ParseArrayContents(data, _1446_rest, eltType, (_1445_len).dtor_u, out _out6, out _out7, out _out8);
        _1447_some2 = _out6;
        _1448_contents = _out7;
        _1449_remainder = _out8;
        if (_1447_some2) {
          success = true;
          v = @_107_Common____GenericMarshalling__i_Compile.V.create_VArray(_1448_contents);
          rest__index = _1449_remainder;
        } else {
          success = false;
          rest__index = (ulong)(data).LongLength;
        }
    ...
    public static _System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>> parse__Tuple__contents(Dafny.Sequence<byte> data, Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.G> eltTypes)
    {
      if ((eltTypes).Equals(Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.G>.FromElements())) {
        ...
        _44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V> _1450_val = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>)_let_tmp_rhs4)._0;
        Dafny.Sequence<byte> _1451_rest1 = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>)_let_tmp_rhs4)._1;
        _System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>> _let_tmp_rhs5 = _107_Common____GenericMarshalling__i_Compile.__default.parse__Tuple__contents(_1451_rest1, (eltTypes).Drop((ulong)(1UL)));
        _44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>> _1452_contents = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>>)_let_tmp_rhs5)._0;
        Dafny.Sequence<byte> _1453_rest2 = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>>)_let_tmp_rhs5)._1;
        if ((!((_1450_val).is_None)) && (!((_1452_contents).is_None))) {
          return @_System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>>.create(@_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>.create_Some((Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>.FromElements((_1450_val).dtor_v)).Concat((_1452_contents).dtor_v)), _1453_rest2);
        } else  {
          return @_System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>>.create(@_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>.create_None(), Dafny.Sequence<byte>.FromElements());
        }
      }
    ...
    public static void ParseTupleContents(byte[] data, ulong index, Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.G> eltTypes, out bool success, out Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V> v, out ulong rest__index)
    {
      ...
      rest__index = 0;
      { }
      _107_Common____GenericMarshalling__i_Compile.V[] _1454_vArr;
      ...
      ulong _1455_i;
      _1455_i = 0UL;
      ulong _1456_next__val__index;
      _1456_next__val__index = index;
      { }
      while ((_1455_i) < ((ulong)(eltTypes).LongCount)) {
        bool _1457_some1;
        _107_Common____GenericMarshalling__i_Compile.V _1458_val;
        ulong _1459_rest1;
        bool _out9;
        _107_Common____GenericMarshalling__i_Compile.V _out10;
        ulong _out11;
        _107_Common____GenericMarshalling__i_Compile.__default.ParseVal(data, _1456_next__val__index, (eltTypes).Select(_1455_i), out _out9, out _out10, out _out11);
        _1457_some1 = _out9;
        _1458_val = _out10;
        _1459_rest1 = _out11;
        { }
        ...
        { }
        (_1454_vArr)[(int)((_1455_i))] = _1458_val;
        _1456_next__val__index = _1459_rest1;
        _1455_i = (_1455_i) + (1UL);
      }
      success = true;
      rest__index = _1456_next__val__index;
      v = Dafny.Helpers.SeqFromArray(_1454_vArr);
      { }
    }
    public static _System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>> parse__Tuple(Dafny.Sequence<byte> data, Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.G> eltTypes)
    {
      ...
      _44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>> _1460_contents = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>>)_let_tmp_rhs6)._0;
      Dafny.Sequence<byte> _1461_rest = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V>>,Dafny.Sequence<byte>>)_let_tmp_rhs6)._1;
      if (!((_1460_contents).is_None)) {
        return @_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>.create(@_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>.create_Some(@_107_Common____GenericMarshalling__i_Compile.V.create_VTuple((_1460_contents).dtor_v)), _1461_rest);
      } else  {
        return @_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>.create(@_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>.create_None(), Dafny.Sequence<byte>.FromElements());
      }
    }
    public static void ParseTuple(byte[] data, ulong index, Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.G> eltTypes, out bool success, out _107_Common____GenericMarshalling__i_Compile.V v, out ulong rest__index)
    {
      ...
      rest__index = 0;
      bool _1462_some;
      Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V> _1463_contents;
      ulong _1464_rest;
      bool _out12;
      ...
      _1462_some = _out12;
      _1463_contents = _out13;
      _1464_rest = _out14;
      if (_1462_some) {
        success = true;
        v = @_107_Common____GenericMarshalling__i_Compile.V.create_VTuple(_1463_contents);
        rest__index = _1464_rest;
      } else {
        success = false;
        rest__index = (ulong)(data).LongLength;
      }
    ...
    public static _System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>> parse__ByteArray(Dafny.Sequence<byte> data) {
      ...
      _44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V> _1465_len = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>)_let_tmp_rhs7)._0;
      Dafny.Sequence<byte> _1466_rest = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>)_let_tmp_rhs7)._1;
      if ((!((_1465_len).is_None)) && ((((_1465_len).dtor_v).dtor_u) <= ((ulong)(_1466_rest).LongCount))) {
        return @_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>.create(@_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>.create_Some(@_107_Common____GenericMarshalling__i_Compile.V.create_VByteArray((_1466_rest).Take(((_1465_len).dtor_v).dtor_u).Drop((ulong)(0UL)))), (_1466_rest).Drop(((_1465_len).dtor_v).dtor_u));
      } else  {
        return @_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>.create(@_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>.create_None(), Dafny.Sequence<byte>.FromElements());
      }
    }
    ...
    TAIL_CALL_START: ;
      ...
      rest__index = 0;
      bool _1467_some;
      _107_Common____GenericMarshalling__i_Compile.V _1468_len;
      ulong _1469_rest;
      bool _out15;
      ...
      _1468_len = _out16;
      _1469_rest = _out17;
      if ((_1467_some) && (((_1468_len).dtor_u) <= (((ulong)(data).LongLength) - (_1469_rest)))) {
        Dafny.Sequence<byte> _1470_rest__seq;
        _1470_rest__seq = Dafny.Helpers.SeqFromArray(data).Drop(_1469_rest);
        { }
        { }
        success = true;
        v = @_107_Common____GenericMarshalling__i_Compile.V.create_VByteArray(Dafny.Helpers.SeqFromArray(data).Take((_1469_rest) + ((_1468_len).dtor_u)).Drop(_1469_rest));
        rest__index = (_1469_rest) + ((_1468_len).dtor_u);
      } else {
        success = false;
        rest__index = (ulong)(data).LongLength;
      }
    ...
    public static _System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>> parse__Case(Dafny.Sequence<byte> data, Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.G> cases)
    {
      ...
      _44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V> _1471_caseID = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>)_let_tmp_rhs8)._0;
      Dafny.Sequence<byte> _1472_rest1 = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>)_let_tmp_rhs8)._1;
      if ((!((_1471_caseID).is_None)) && ((((_1471_caseID).dtor_v).dtor_u) < ((ulong)(cases).LongCount))) {
        _System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>> _let_tmp_rhs9 = _107_Common____GenericMarshalling__i_Compile.__default.parse__Val(_1472_rest1, (cases).Select(((_1471_caseID).dtor_v).dtor_u));
        _44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V> _1473_val = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>)_let_tmp_rhs9)._0;
        Dafny.Sequence<byte> _1474_rest2 = ((_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>)_let_tmp_rhs9)._1;
        if (!((_1473_val).is_None)) {
          return @_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>.create(@_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>.create_Some(@_107_Common____GenericMarshalling__i_Compile.V.create_VCase(((_1471_caseID).dtor_v).dtor_u, (_1473_val).dtor_v)), _1474_rest2);
        } else  {
          return @_System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>>.create(@_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>.create_None(), Dafny.Sequence<byte>.FromElements());
        }
      } else  {
    ...
    public static void ParseCase(byte[] data, ulong index, Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.G> cases, out bool success, out _107_Common____GenericMarshalling__i_Compile.V v, out ulong rest__index)
    {
      ...
      rest__index = 0;
      bool _1475_some1;
      _107_Common____GenericMarshalling__i_Compile.V _1476_caseID;
      ulong _1477_rest1;
      bool _out18;
      ...
      _1476_caseID = _out19;
      _1477_rest1 = _out20;
      if ((_1475_some1) && (((_1476_caseID).dtor_u) < ((ulong)(cases).LongCount))) {
        bool _1478_some2;
        _107_Common____GenericMarshalling__i_Compile.V _1479_val;
        ulong _1480_rest2;
        bool _out21;
        _107_Common____GenericMarshalling__i_Compile.V _out22;
        ulong _out23;
        _107_Common____GenericMarshalling__i_Compile.__default.ParseVal(data, _1477_rest1, (cases).Select((_1476_caseID).dtor_u), out _out21, out _out22, out _out23);
        _1478_some2 = _out21;
        _1479_val = _out22;
        _1480_rest2 = _out23;
        if (_1478_some2) {
          success = true;
          v = @_107_Common____GenericMarshalling__i_Compile.V.create_VCase((_1476_caseID).dtor_u, _1479_val);
          rest__index = _1480_rest2;
        } else {
          success = false;
          rest__index = (ulong)(data).LongLength;
        }
    ...
    public static _System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>> parse__Val(Dafny.Sequence<byte> data, _107_Common____GenericMarshalling__i_Compile.G grammar)
    {
      ...
      if (_source0.is_GUint64) {
        ...
        _107_Common____GenericMarshalling__i_Compile.G _1481_elt = ((_107_Common____GenericMarshalling__i_Compile.G_GArray)_source0).elt;
        return _107_Common____GenericMarshalling__i_Compile.__default.parse__Array(data, _1481_elt);
      } else if (_source0.is_GTuple) {
        Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.G> _1482_t = ((_107_Common____GenericMarshalling__i_Compile.G_GTuple)_source0).t;
        return _107_Common____GenericMarshalling__i_Compile.__default.parse__Tuple(data, _1482_t);
      } else if (_source0.is_GByteArray) {
        return _107_Common____GenericMarshalling__i_Compile.__default.parse__ByteArray(data);
      } else  {
        Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.G> _1483_cases = ((_107_Common____GenericMarshalling__i_Compile.G_GTaggedUnion)_source0).cases;
        return _107_Common____GenericMarshalling__i_Compile.__default.parse__Case(data, _1483_cases);
      }
    }
    public static void ParseVal(byte[] data, ulong index, _107_Common____GenericMarshalling__i_Compile.G grammar, out bool success, out _107_Common____GenericMarshalling__i_Compile.V v, out ulong rest__index)
    {
      ...
      if (_source1.is_GUint64) {
        ...
        _107_Common____GenericMarshalling__i_Compile.G _1484_elt = ((_107_Common____GenericMarshalling__i_Compile.G_GArray)_source1).elt;
        bool _out27;
        _107_Common____GenericMarshalling__i_Compile.V _out28;
        ulong _out29;
        _107_Common____GenericMarshalling__i_Compile.__default.ParseArray(data, index, _1484_elt, out _out27, out _out28, out _out29);
        success = _out27;
        v = _out28;
        rest__index = _out29;
      } else if (_source1.is_GTuple) {
        Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.G> _1485_t = ((_107_Common____GenericMarshalling__i_Compile.G_GTuple)_source1).t;
        bool _out30;
        _107_Common____GenericMarshalling__i_Compile.V _out31;
        ulong _out32;
        _107_Common____GenericMarshalling__i_Compile.__default.ParseTuple(data, index, _1485_t, out _out30, out _out31, out _out32);
        success = _out30;
        v = _out31;
        rest__index = _out32;
        ...
        Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.G> _1486_cases = ((_107_Common____GenericMarshalling__i_Compile.G_GTaggedUnion)_source1).cases;
        bool _out36;
        _107_Common____GenericMarshalling__i_Compile.V _out37;
        ulong _out38;
        _107_Common____GenericMarshalling__i_Compile.__default.ParseCase(data, index, _1486_cases, out _out36, out _out37, out _out38);
        success = _out36;
        v = _out37;
        rest__index = _out38;
      }
    ...
    public static void Demarshall(byte[] data, _107_Common____GenericMarshalling__i_Compile.G grammar, out bool success, out _107_Common____GenericMarshalling__i_Compile.V v)
    {
      ...
      v = _out40;
      _1487_rest = _out41;
      if ((success) && ((_1487_rest) == ((ulong)(data).LongLength))) {
        { }
        { }
        { }
      } else {
    ...
    public static void ComputeSeqSum(Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V> s, out ulong size)
    {
      ...
      if (((ulong)(s).LongCount) == (0UL)) {
        ...
        _1488_v__size = _out42;
        ulong _1489_rest__size;
        ulong _out43;
        _107_Common____GenericMarshalling__i_Compile.__default.ComputeSeqSum((s).Drop((ulong)(1UL)), out _out43);
        _1489_rest__size = _out43;
        size = (_1488_v__size) + (_1489_rest__size);
      }
    }
    public static void ComputeSizeOf(_107_Common____GenericMarshalling__i_Compile.V val, out ulong size)
    {
      ...
      if (_source2.is_VUint64) {
        ulong _1490___v3 = ((_107_Common____GenericMarshalling__i_Compile.V_VUint64)_source2).u;
        size = 8UL;
      } else if (_source2.is_VArray) {
        Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V> _1491_a = ((_107_Common____GenericMarshalling__i_Compile.V_VArray)_source2).a;
        ulong _1492_v;
        ulong _out44;
        _107_Common____GenericMarshalling__i_Compile.__default.ComputeSeqSum(_1491_a, out _out44);
        _1492_v = _out44;
        if ((_1492_v) == (0UL)) {
          size = 8UL;
        } else {
        ...
        Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V> _1493_t = ((_107_Common____GenericMarshalling__i_Compile.V_VTuple)_source2).t;
        ulong _out45;
        _107_Common____GenericMarshalling__i_Compile.__default.ComputeSeqSum(_1493_t, out _out45);
        size = _out45;
      } else if (_source2.is_VByteArray) {
        Dafny.Sequence<byte> _1494_b = ((_107_Common____GenericMarshalling__i_Compile.V_VByteArray)_source2).b;
        size = (8UL) + ((ulong)(_1494_b).LongCount);
      } else  {
        ulong _1495_c = ((_107_Common____GenericMarshalling__i_Compile.V_VCase)_source2).c;
        _107_Common____GenericMarshalling__i_Compile.V _1496_v = ((_107_Common____GenericMarshalling__i_Compile.V_VCase)_source2).val;
        ulong _1497_vs;
        ulong _out46;
        _107_Common____GenericMarshalling__i_Compile.__default.ComputeSizeOf(_1496_v, out _out46);
        _1497_vs = _out46;
        size = (8UL) + (_1497_vs);
      }
    }
    ...
    {
    TAIL_CALL_START: ;
      _System.Tuple2<_44_Logic____Option__i_Compile.Option<_107_Common____GenericMarshalling__i_Compile.V>,Dafny.Sequence<byte>> _1498_tuple;
      _1498_tuple = _107_Common____GenericMarshalling__i_Compile.__default.parse__Uint64(Dafny.Helpers.SeqFromArray(data).Drop(index));
    ...
    public static void MarshallArrayContents(Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V> contents, _107_Common____GenericMarshalling__i_Compile.G eltType, byte[] data, ulong index, out ulong size)
    {
      ...
      ulong _1499_i;
      _1499_i = 0UL;
      ulong _1500_cur__index;
      _1500_cur__index = index;
      { }
      { }
      { }
      { }
      while ((_1499_i) < ((ulong)(contents).LongCount)) {
        { }
        { }
        ulong _1501_item__size;
        ulong _out47;
        _107_Common____GenericMarshalling__i_Compile.__default.MarshallVal((contents).Select(_1499_i), eltType, data, _1500_cur__index, out _out47);
        _1501_item__size = _out47;
        { }
        { }
        { }
        { }
        { }
        { }
        _1500_cur__index = (_1500_cur__index) + (_1501_item__size);
        _1499_i = (_1499_i) + (1UL);
        { }
        { }
        { }
    ...
    public static void MarshallTupleContents(Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V> contents, Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.G> eltTypes, byte[] data, ulong index, out ulong size)
    {
      ...
      ulong _1503_i;
      _1503_i = 0UL;
      ulong _1504_cur__index;
      _1504_cur__index = index;
      { }
      { }
      { }
      { }
      while ((_1503_i) < ((ulong)(contents).LongCount)) {
        { }
        { }
        { }
        { }
        { }
        ulong _1505_item__size;
        ulong _out49;
        _107_Common____GenericMarshalling__i_Compile.__default.MarshallVal((contents).Select(_1503_i), (eltTypes).Select(_1503_i), data, _1504_cur__index, out _out49);
        _1505_item__size = _out49;
        { }
        { }
        { }
        { }
        { }
        { }
        _1504_cur__index = (_1504_cur__index) + (_1505_item__size);
        _1503_i = (_1503_i) + (1UL);
        { }
        { }
        { }
    ...
    public static void MarshallVal(_107_Common____GenericMarshalling__i_Compile.V val, _107_Common____GenericMarshalling__i_Compile.G grammar, byte[] data, ulong index, out ulong size)
    {
      ...
      if (_source3.is_VUint64) {
        ulong _1507___v4 = ((_107_Common____GenericMarshalling__i_Compile.V_VUint64)_source3).u;
        ulong _out52;
        ...
        Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V> _1508___v5 = ((_107_Common____GenericMarshalling__i_Compile.V_VArray)_source3).a;
        ulong _out53;
        ...
        Dafny.Sequence<_107_Common____GenericMarshalling__i_Compile.V> _1509___v6 = ((_107_Common____GenericMarshalling__i_Compile.V_VTuple)_source3).t;
        ulong _out54;
        ...
        Dafny.Sequence<byte> _1510___v7 = ((_107_Common____GenericMarshalling__i_Compile.V_VByteArray)_source3).b;
        ulong _out55;
        _107_Common____GenericMarshalling__i_Compile.__default.MarshallByteArray(val, grammar, data, index, out _out55);
        size = _out55;
      } else  {
        ulong _1511___v8 = ((_107_Common____GenericMarshalling__i_Compile.V_VCase)_source3).c;
        _107_Common____GenericMarshalling__i_Compile.V _1512___v9 = ((_107_Common____GenericMarshalling__i_Compile.V_VCase)_source3).val;
        ulong _out56;
...
namespace _111_PacketParsing__i_Compile {
  ...
  public partial class __default {
    ...
    TAIL_CALL_START: ;
      ...
      bool _1515_success;
      _107_Common____GenericMarshalling__i_Compile.V _1516_val;
      bool _out59;
      ...
      _1515_success = _out59;
      _1516_val = _out60;
      if (_1515_success) {
        msg = _111_PacketParsing__i_Compile.__default.ParseCMessage(_1516_val);
        { }
      } else {
    ...
    public static void MarshallMessage(_39_Message__i_Compile.CMessage c, out _107_Common____GenericMarshalling__i_Compile.V val)
    {
      val = @_107_Common____GenericMarshalling__i_Compile.V.Default;
      if ((c).is_CTransfer) {
        _107_Common____GenericMarshalling__i_Compile.V _1517_msg;
        ...
        _1517_msg = _out61;
        val = @_107_Common____GenericMarshalling__i_Compile.V.create_VCase(0UL, _1517_msg);
      } else if ((c).is_CLocked) {
        _107_Common____GenericMarshalling__i_Compile.V _1518_msg;
        ...
        _1518_msg = _out62;
        val = @_107_Common____GenericMarshalling__i_Compile.V.create_VCase(1UL, _1518_msg);
      } else { }
    }
    ...
    TAIL_CALL_START: ;
      data = new byte[0];
      _107_Common____GenericMarshalling__i_Compile.V _1519_val;
      ...
      _1519_val = _out63;
      byte[] _out64;
      _107_Common____GenericMarshalling__i_Compile.__default.Marshall(_1519_val, _111_PacketParsing__i_Compile.__default.CMessageGrammar(), out _out64);
      data = _out64;
    }
  }
  ...
  public partial class __default {
    ...
    TAIL_CALL_START: ;
      ...
      if (((s).dtor_held) && (((s).dtor_epoch) < (18446744073709551615UL))) {
        _115_Impl__Node__i_Compile.CNode _1520_ssss;
        _1520_ssss = @_115_Impl__Node__i_Compile.CNode.create(false, (s).dtor_epoch, (s).dtor_my__index, (s).dtor_config);
        s_k = _1520_ssss;
        ulong _1521_dst__index;
        _1521_dst__index = (((s).dtor_my__index) + (1UL)) % ((ulong)((s).dtor_config).LongCount);
        packet = @_44_Logic____Option__i_Compile.Option<_7_Environment__s_Compile.LPacket<_9_Native____Io__s_Compile.EndPoint,_39_Message__i_Compile.CMessage>>.create_Some(@_7_Environment__s_Compile.LPacket<_9_Native____Io__s_Compile.EndPoint,_39_Message__i_Compile.CMessage>.create(((s).dtor_config).Select(_1521_dst__index), ((s).dtor_config).Select((s).dtor_my__index), @_39_Message__i_Compile.CMessage.create_CTransfer(((s).dtor_epoch) + (1UL))));
        { }
    ...
    TAIL_CALL_START: ;
      ...
      if ((((!((s).dtor_held)) && (((s).dtor_config).Contains((transfer__packet).dtor_src))) && (((transfer__packet).dtor_msg).is_CTransfer)) && ((((transfer__packet).dtor_msg).dtor_transfer__epoch) > ((s).dtor_epoch))) {
        _115_Impl__Node__i_Compile.CNode _1522_ssss;
        _1522_ssss = @_115_Impl__Node__i_Compile.CNode.create(true, ((transfer__packet).dtor_msg).dtor_transfer__epoch, (s).dtor_my__index, (s).dtor_config);
        s_k = _1522_ssss;
...
namespace _119_UdpLock__i_Compile {
  ...
  public partial class __default {
    ...
    TAIL_CALL_START: ;
      ...
      _1523_addr = _out65;
      ushort _1524_port;
      _1524_port = (ipe).GetPort();
      ep = @_9_Native____Io__s_Compile.EndPoint.create(Dafny.Helpers.SeqFromArray(_1523_addr), _1524_port);
    }
    public static void Receive(_9_Native____Io__s_Compile.UdpClient udpClient, _9_Native____Io__s_Compile.EndPoint localAddr, out _119_UdpLock__i_Compile.ReceiveResult rr)
    {
      ...
      bool _1526_ok;
      bool _1527_timedOut;
      _9_Native____Io__s_Compile.IPEndPoint _1528_remote;
      byte[] _1529_buffer;
      bool _out66;
      bool _out67;
      _9_Native____Io__s_Compile.IPEndPoint _out68;
      byte[] _out69;
      (udpClient).Receive(_1525_timeout, out _out66, out _out67, out _out68, out _out69);
      _1526_ok = _out66;
      _1527_timedOut = _out67;
      _1528_remote = _out68;
      _1529_buffer = _out69;
      if (!(_1526_ok)) {
      ...
      { }
      _39_Message__i_Compile.CMessage _1530_cmessage;
      _39_Message__i_Compile.CMessage _out70;
      _111_PacketParsing__i_Compile.__default.DemarshallDataMethod(_1529_buffer, out _out70);
      _1530_cmessage = _out70;
      _9_Native____Io__s_Compile.EndPoint _1531_srcEp;
      _9_Native____Io__s_Compile.EndPoint _out71;
      _119_UdpLock__i_Compile.__default.GetEndPoint(_1528_remote, out _out71);
      _1531_srcEp = _out71;
      _7_Environment__s_Compile.LPacket<_9_Native____Io__s_Compile.EndPoint,_39_Message__i_Compile.CMessage> _1532_cpacket;
      _1532_cpacket = @_7_Environment__s_Compile.LPacket<_9_Native____Io__s_Compile.EndPoint,_39_Message__i_Compile.CMessage>.create(localAddr, _1531_srcEp, _1530_cmessage);
      rr = @_119_UdpLock__i_Compile.ReceiveResult.create_RRPacket(_1532_cpacket);
    }
    public static void SendPacket(_9_Native____Io__s_Compile.UdpClient udpClient, _44_Logic____Option__i_Compile.Option<_7_Environment__s_Compile.LPacket<_9_Native____Io__s_Compile.EndPoint,_39_Message__i_Compile.CMessage>> opt__packet, out bool ok)
    {
      ...
      if ((opt__packet).is_None) {
        ...
        _7_Environment__s_Compile.LPacket<_9_Native____Io__s_Compile.EndPoint,_39_Message__i_Compile.CMessage> _1533_cpacket;
        _1533_cpacket = (opt__packet).dtor_v;
        _9_Native____Io__s_Compile.EndPoint _1534_dstEp;
        _1534_dstEp = (_1533_cpacket).dtor_dst;
        byte[] _1535_dstAddrAry;
        byte[] _out72;
        _101_Common____Util__i_Compile.__default.seqToArrayOpt<byte>((_1534_dstEp).dtor_addr, out _out72);
        _1535_dstAddrAry = _out72;
        _9_Native____Io__s_Compile.IPEndPoint _1536_remote = default(_9_Native____Io__s_Compile.IPEndPoint);
        bool _out73;
        _9_Native____Io__s_Compile.IPEndPoint _out74;
        _9_Native____Io__s_Compile.IPEndPoint.Construct(_1535_dstAddrAry, (_1534_dstEp).dtor_port, out _out73, out _out74);
        ok = _out73;
        _1536_remote = _out74;
        if (!(ok)) {
          return;
        ...
        byte[] _1537_buffer;
        byte[] _out75;
        _111_PacketParsing__i_Compile.__default.MarshallLockMessage((_1533_cpacket).dtor_msg, out _out75);
        _1537_buffer = _out75;
        bool _out76;
        (udpClient).Send(_1536_remote, _1537_buffer, out _out76);
        ok = _out76;
        if (!(ok)) {
          return;
        }
...
namespace _121_NodeImpl__i_Compile {
  ...
  public partial class NodeImpl {
    ...
    TAIL_CALL_START: ;
      ...
      _9_Native____Io__s_Compile.EndPoint _1538_my__ep;
      _1538_my__ep = me;
      byte[] _1539_ip__byte__array;
      var _nw6 = new byte[(int)(new BigInteger(((_1538_my__ep).dtor_addr).Count))];
      _1539_ip__byte__array = _nw6;
      _101_Common____Util__i_Compile.__default.seqIntoArrayOpt<byte>((_1538_my__ep).dtor_addr, _1539_ip__byte__array);
      _9_Native____Io__s_Compile.IPEndPoint _1540_ip__endpoint = default(_9_Native____Io__s_Compile.IPEndPoint);
      bool _out77;
      _9_Native____Io__s_Compile.IPEndPoint _out78;
      _9_Native____Io__s_Compile.IPEndPoint.Construct(_1539_ip__byte__array, (_1538_my__ep).dtor_port, out _out77, out _out78);
      ok = _out77;
      _1540_ip__endpoint = _out78;
      if (!(ok)) {
        return;
      }
      bool _out79;
      _9_Native____Io__s_Compile.UdpClient _out80;
      _9_Native____Io__s_Compile.UdpClient.Construct(_1540_ip__endpoint, out _out79, out _out80);
      ok = _out79;
      client = _out80;
      { }
    }
    ...
    {
      ok = false;
      _44_Logic____Option__i_Compile.Option<_7_Environment__s_Compile.LPacket<_9_Native____Io__s_Compile.EndPoint,_39_Message__i_Compile.CMessage>> _1541_transfer__packet = @_44_Logic____Option__i_Compile.Option<_7_Environment__s_Compile.LPacket<_9_Native____Io__s_Compile.EndPoint,_39_Message__i_Compile.CMessage>>.Default;
      ...
      (this).node = _out84;
      _1541_transfer__packet = _out85;
      ok = true;
      if ((_1541_transfer__packet).is_Some) {
        { }
        bool _out86;
        _119_UdpLock__i_Compile.__default.SendPacket(this.udpClient, _1541_transfer__packet, out _out86);
        ok = _out86;
        { }
      } else { }
    }
    ...
    TAIL_CALL_START: ;
      ok = false;
      _119_UdpLock__i_Compile.ReceiveResult _1542_rr = @_119_UdpLock__i_Compile.ReceiveResult.Default;
      { }
      ...
      _1542_rr = _out87;
      { }
      if ((_1542_rr).is_RRFail) {
        ok = false;
        return;
      } else if ((_1542_rr).is_RRTimeout) {
        ok = true;
        { }
        return;
      } else {
        ok = true;
        _44_Logic____Option__i_Compile.Option<_7_Environment__s_Compile.LPacket<_9_Native____Io__s_Compile.EndPoint,_39_Message__i_Compile.CMessage>> _1543_locked__packet = @_44_Logic____Option__i_Compile.Option<_7_Environment__s_Compile.LPacket<_9_Native____Io__s_Compile.EndPoint,_39_Message__i_Compile.CMessage>>.Default;
        ...
        _115_Impl__Node__i_Compile.__default.NodeAcceptImpl(_this.node, (_1542_rr).dtor_cpacket, out _out88, out _out89);
        (_this).node = _out88;
        _1543_locked__packet = _out89;
        if ((_1543_locked__packet).is_Some) {
          { }
          bool _out90;
          _119_UdpLock__i_Compile.__default.SendPacket(_this.udpClient, _1543_locked__packet, out _out90);
          ok = _out90;
          { }
        }
      }
  ...
  public partial class __default {
    ...
    public static _System.Tuple2<bool,Dafny.Sequence<byte>> shorts__to__bytes(Dafny.Sequence<ushort> shorts) {
      if ((new BigInteger((shorts).Count)) == (new BigInteger(0))) {
        ...
        _System.Tuple2<bool,Dafny.Sequence<byte>> _1545_tuple = _127_CmdLineParser__i_Compile.__default.shorts__to__bytes((shorts).Drop(new BigInteger(1)));
        bool _1546_ok = (_1545_tuple).dtor__0;
        Dafny.Sequence<byte> _1547_rest = (_1545_tuple).dtor__1;
        _System.Tuple2<bool,byte> _1548_tuple_k = _127_CmdLineParser__i_Compile.__default.ascii__to__int((shorts).Select(new BigInteger(0)));
        bool _1549_ok_k = (_1548_tuple_k).dtor__0;
        byte _1550_a__byte = (_1548_tuple_k).dtor__1;
        if ((_1546_ok) && (_1549_ok_k)) {
          return @_System.Tuple2<bool,Dafny.Sequence<byte>>.create(true, (Dafny.Sequence<byte>.FromElements(_1550_a__byte)).Concat(_1547_rest));
        } else  {
    ...
    public static _System.Tuple2<bool,BigInteger> shorts__to__nat(Dafny.Sequence<ushort> shorts) {
      if ((new BigInteger((shorts).Count)) == (new BigInteger(0))) {
        ...
        _System.Tuple2<bool,Dafny.Sequence<byte>> _1551_tuple = _127_CmdLineParser__i_Compile.__default.shorts__to__bytes(shorts);
        bool _1552_ok = (_1551_tuple).dtor__0;
        Dafny.Sequence<byte> _1553_bytes = (_1551_tuple).dtor__1;
        if (!(_1552_ok)) {
          return @_System.Tuple2<bool,BigInteger>.create(false, new BigInteger(0));
        } else  {
          return @_System.Tuple2<bool,BigInteger>.create(true, _127_CmdLineParser__i_Compile.__default.bytes__to__decimal(_1553_bytes));
        }
      }
    }
    public static _System.Tuple2<bool,byte> shorts__to__byte(Dafny.Sequence<ushort> shorts) {
      _System.Tuple2<bool,BigInteger> _1554_tuple = _127_CmdLineParser__i_Compile.__default.shorts__to__nat(shorts);
      bool _1555_ok = (_1554_tuple).dtor__0;
      BigInteger _1556_val = (_1554_tuple).dtor__1;
      if (((new BigInteger(0)) <= (_1556_val)) && ((_1556_val) < (new BigInteger(256)))) {
        return @_System.Tuple2<bool,byte>.create(true, (byte)(_1556_val));
      } else  {
        return @_System.Tuple2<bool,byte>.create(false, 0);
      }
    }
    public static _System.Tuple2<bool,ushort> shorts__to__uint16(Dafny.Sequence<ushort> shorts) {
      _System.Tuple2<bool,BigInteger> _1557_tuple = _127_CmdLineParser__i_Compile.__default.shorts__to__nat(shorts);
      bool _1558_ok = (_1557_tuple).dtor__0;
      BigInteger _1559_val = (_1557_tuple).dtor__1;
      if (((new BigInteger(0)) <= (_1559_val)) && ((_1559_val) < (new BigInteger(65536)))) {
        return @_System.Tuple2<bool,ushort>.create(true, (ushort)(_1559_val));
      } else  {
    ...
    public static _System.Tuple2<bool,uint> shorts__to__uint32(Dafny.Sequence<ushort> shorts) {
      _System.Tuple2<bool,BigInteger> _1560_tuple = _127_CmdLineParser__i_Compile.__default.shorts__to__nat(shorts);
      bool _1561_ok = (_1560_tuple).dtor__0;
      BigInteger _1562_val = (_1560_tuple).dtor__1;
      if (((new BigInteger(0)) <= (_1562_val)) && ((_1562_val) < (BigInteger.Parse("4294967296")))) {
        return @_System.Tuple2<bool,uint>.create(true, (uint)(_1562_val));
      } else  {
    ...
    public static _System.Tuple2<bool,Dafny.Sequence<byte>> parse__ip__addr__helper(Dafny.Sequence<ushort> ip__shorts, Dafny.Sequence<ushort> current__octet__shorts)
    {
      if ((new BigInteger((ip__shorts).Count)) == (new BigInteger(0))) {
        _System.Tuple2<bool,byte> _1563_tuple = _127_CmdLineParser__i_Compile.__default.shorts__to__byte(current__octet__shorts);
        bool _1564_okay = (_1563_tuple).dtor__0;
        byte _1565_b = (_1563_tuple).dtor__1;
        if (!(_1564_okay)) {
          return @_System.Tuple2<bool,Dafny.Sequence<byte>>.create(false, Dafny.Sequence<byte>.FromElements());
        } else  {
          return @_System.Tuple2<bool,Dafny.Sequence<byte>>.create(true, Dafny.Sequence<byte>.FromElements(_1565_b));
        }
      } else  {
        if (_127_CmdLineParser__i_Compile.__default.is__ascii__period((ip__shorts).Select(new BigInteger(0)))) {
          _System.Tuple2<bool,byte> _1566_tuple = _127_CmdLineParser__i_Compile.__default.shorts__to__byte(current__octet__shorts);
          bool _1567_okay = (_1566_tuple).dtor__0;
          byte _1568_b = (_1566_tuple).dtor__1;
          if (!(_1567_okay)) {
            return @_System.Tuple2<bool,Dafny.Sequence<byte>>.create(false, Dafny.Sequence<byte>.FromElements());
          } else  {
            _System.Tuple2<bool,Dafny.Sequence<byte>> _1569_tuple_k = _127_CmdLineParser__i_Compile.__default.parse__ip__addr__helper((ip__shorts).Drop(new BigInteger(1)), Dafny.Sequence<ushort>.FromElements());
            bool _1570_ok = (_1569_tuple_k).dtor__0;
            Dafny.Sequence<byte> _1571_ip__bytes = (_1569_tuple_k).dtor__1;
            if (!(_1570_ok)) {
              return @_System.Tuple2<bool,Dafny.Sequence<byte>>.create(false, Dafny.Sequence<byte>.FromElements());
            } else  {
              return @_System.Tuple2<bool,Dafny.Sequence<byte>>.create(true, (Dafny.Sequence<byte>.FromElements(_1568_b)).Concat(_1571_ip__bytes));
            }
          }
        } else  {
    ...
    public static _System.Tuple2<bool,Dafny.Sequence<byte>> parse__ip__addr(Dafny.Sequence<ushort> ip__shorts) {
      _System.Tuple2<bool,Dafny.Sequence<byte>> _1572_tuple = _127_CmdLineParser__i_Compile.__default.parse__ip__addr__helper(ip__shorts, Dafny.Sequence<ushort>.FromElements());
      bool _1573_ok = (_1572_tuple).dtor__0;
      Dafny.Sequence<byte> _1574_ip__bytes = (_1572_tuple).dtor__1;
      if ((_1573_ok) && ((new BigInteger((_1574_ip__bytes).Count)) == (new BigInteger(4)))) {
        return @_System.Tuple2<bool,Dafny.Sequence<byte>>.create(true, _1574_ip__bytes);
      } else  {
        return @_System.Tuple2<bool,Dafny.Sequence<byte>>.create(false, Dafny.Sequence<byte>.FromElements());
      }
    }
    ...
    {
      _System.Tuple2<bool,Dafny.Sequence<byte>> _1575_tuple = _127_CmdLineParser__i_Compile.__default.parse__ip__addr(ip__shorts);
      bool _1576_okay = (_1575_tuple).dtor__0;
      Dafny.Sequence<byte> _1577_ip__bytes = (_1575_tuple).dtor__1;
      if (!(_1576_okay)) {
        ...
        _System.Tuple2<bool,ushort> _1578_tuple_k = _127_CmdLineParser__i_Compile.__default.shorts__to__uint16(port__shorts);
        bool _1579_okay_k = (_1578_tuple_k).dtor__0;
        ushort _1580_port = (_1578_tuple_k).dtor__1;
        if (!(_1579_okay_k)) {
          return @_System.Tuple2<bool,_9_Native____Io__s_Compile.EndPoint>.create(false, @_9_Native____Io__s_Compile.EndPoint.create(Dafny.Sequence<byte>.FromElements(0, 0, 0, 0), 0));
        } else  {
          return @_System.Tuple2<bool,_9_Native____Io__s_Compile.EndPoint>.create(true, @_9_Native____Io__s_Compile.EndPoint.create(_1577_ip__bytes, _1580_port));
        }
      }
    }
    ...
    TAIL_CALL_START: ;
      ...
      unique = true;
      BigInteger _1581_i;
      _1581_i = new BigInteger(0);
      while ((_1581_i) < (new BigInteger((endpoints).Count))) {
        BigInteger _1582_j;
        _1582_j = new BigInteger(0);
        while ((_1582_j) < (new BigInteger((endpoints).Count))) {
          if (((_1581_i) != (_1582_j)) && (((endpoints).Select(_1581_i)).Equals((endpoints).Select(_1582_j)))) {
            unique = false;
            { }
            return;
          }
          _1582_j = (_1582_j) + (new BigInteger(1));
        }
        _1581_i = (_1581_i) + (new BigInteger(1));
      }
      { }
    }
    public static _System.Tuple2<bool,Dafny.Sequence<_9_Native____Io__s_Compile.EndPoint>> parse__end__points(Dafny.Sequence<Dafny.Sequence<ushort>> args) {
      if ((new BigInteger((args).Count)) == (new BigInteger(0))) {
        ...
        bool _1583_ok1 = ((_System.Tuple2<bool,_9_Native____Io__s_Compile.EndPoint>)_let_tmp_rhs10)._0;
        _9_Native____Io__s_Compile.EndPoint _1584_ep = ((_System.Tuple2<bool,_9_Native____Io__s_Compile.EndPoint>)_let_tmp_rhs10)._1;
        ...
        bool _1585_ok2 = ((_System.Tuple2<bool,Dafny.Sequence<_9_Native____Io__s_Compile.EndPoint>>)_let_tmp_rhs11)._0;
        Dafny.Sequence<_9_Native____Io__s_Compile.EndPoint> _1586_rest = ((_System.Tuple2<bool,Dafny.Sequence<_9_Native____Io__s_Compile.EndPoint>>)_let_tmp_rhs11)._1;
        if (!((_1583_ok1) && (_1585_ok2))) {
          ...
          return @_System.Tuple2<bool,Dafny.Sequence<_9_Native____Io__s_Compile.EndPoint>>.create(true, (Dafny.Sequence<_9_Native____Io__s_Compile.EndPoint>.FromElements(_1584_ep)).Concat(_1586_rest));
        }
      }
    }
    ...
    TAIL_CALL_START: ;
      ...
      uint _1587_num__args;
      uint _out94;
      _9_Native____Io__s_Compile.HostConstants.NumCommandLineArgs(out _out94);
      _1587_num__args = _out94;
      uint _1588_i;
      _1588_i = 0U;
      args = Dafny.Sequence<Dafny.Sequence<ushort>>.FromElements();
      while ((_1588_i) < (_1587_num__args)) {
        ushort[] _1589_arg;
        ushort[] _out95;
        _9_Native____Io__s_Compile.HostConstants.GetCommandLineArg((ulong)(_1588_i), out _out95);
        _1589_arg = _out95;
        args = (args).Concat(Dafny.Sequence<Dafny.Sequence<ushort>>.FromElements(Dafny.Helpers.SeqFromArray(_1589_arg)));
        _1588_i = (_1588_i) + (1U);
      }
    }
  }
...
namespace _129_LockCmdLineParser__i_Compile {
  ...
  public partial class __default {
    ...
    TAIL_CALL_START: ;
      ...
      ulong _1590_i;
      _1590_i = 0UL;
      while ((_1590_i) < ((ulong)(hosts).LongCount)) {
        if ((host).Equals((hosts).Select(_1590_i))) {
          found = true;
          index = _1590_i;
          { }
          return;
        }
        if ((_1590_i) == (((ulong)(hosts).LongCount) - (1UL))) {
          found = false;
          return;
        }
        _1590_i = (_1590_i) + (1UL);
    ...
    public static void ParseCmdLine(out bool ok, out Dafny.Sequence<_9_Native____Io__s_Compile.EndPoint> host__ids, out ulong my__index)
    {
      ...
      my__index = 0;
      ok = false;
      uint _1591_num__args;
      uint _out96;
      _9_Native____Io__s_Compile.HostConstants.NumCommandLineArgs(out _out96);
      _1591_num__args = _out96;
      if (((_1591_num__args) < (4U)) || (((_1591_num__args) % (2U)) != (1U))) {
      ...
      Dafny.Sequence<Dafny.Sequence<ushort>> _1592_args;
      Dafny.Sequence<Dafny.Sequence<ushort>> _out97;
      _127_CmdLineParser__i_Compile.__default.collect__cmd__line__args(out _out97);
      _1592_args = _out97;
      { }
      _System.Tuple2<bool,Dafny.Sequence<_9_Native____Io__s_Compile.EndPoint>> _1593_tuple1;
      _1593_tuple1 = _127_CmdLineParser__i_Compile.__default.parse__end__points((_1592_args).Take((new BigInteger((_1592_args).Count)) - (new BigInteger(2))).Drop(new BigInteger(1)));
      ok = (_1593_tuple1).dtor__0;
      Dafny.Sequence<_9_Native____Io__s_Compile.EndPoint> _1594_endpoints;
      _1594_endpoints = (_1593_tuple1).dtor__1;
      if (((!(ok)) || ((new BigInteger((_1594_endpoints).Count)) == (new BigInteger(0)))) || ((new BigInteger((_1594_endpoints).Count)) >= (BigInteger.Parse("18446744073709551616")))) {
        ok = false;
        return;
      }
      _System.Tuple2<bool,_9_Native____Io__s_Compile.EndPoint> _1595_tuple2;
      _1595_tuple2 = _127_CmdLineParser__i_Compile.__default.parse__end__point((_1592_args).Select((new BigInteger((_1592_args).Count)) - (new BigInteger(2))), (_1592_args).Select((new BigInteger((_1592_args).Count)) - (new BigInteger(1))));
      ok = (_1595_tuple2).dtor__0;
      if (!(ok)) {
        return;
      }
      bool _1596_unique;
      bool _out98;
      _127_CmdLineParser__i_Compile.__default.test__unique_k(_1594_endpoints, out _out98);
      _1596_unique = _out98;
      if (!(_1596_unique)) {
        ok = false;
        return;
      ...
      bool _out99;
      ulong _out100;
      _129_LockCmdLineParser__i_Compile.__default.GetHostIndex((_1595_tuple2).dtor__1, _1594_endpoints, out _out99, out _out100);
      ok = _out99;
      my__index = _out100;
      if (!(ok)) {
        return;
      }
      host__ids = _1594_endpoints;
      _9_Native____Io__s_Compile.EndPoint _1597_me;
      _1597_me = (_1594_endpoints).Select(my__index);
      { }
      { }
      { }
      { }
...
namespace _131_Host__i_Compile {
  ...
  public partial class __default {
    ...
    TAIL_CALL_START: ;
      ...
      ok = _out101;
      config = _out102;
      _1598_my__index = _out103;
      if (!(ok)) {
        return;
      }
      id = (config).Select(_1598_my__index);
      _121_NodeImpl__i_Compile.NodeImpl _1599_node__impl;
      var _nw7 = new _121_NodeImpl__i_Compile.NodeImpl();
      _nw7.__ctor();
      _1599_node__impl = _nw7;
      bool _out104;
      (_1599_node__impl).InitNode(config, _1598_my__index, out _out104);
      ok = _out104;
      if (!(ok)) {
        return;
      }
      host__state = @_131_Host__i_Compile.CScheduler.create(_1599_node__impl);
      { }
      { }
    }
...
namespace _148_Common____SeqIsUnique__i_Compile {
  ...
  public partial class __default {
    ...
    TAIL_CALL_START: ;
      ...
      BigInteger _1601_i;
      _1601_i = new BigInteger(0);
      while ((_1601_i) < (new BigInteger((xs).Count))) {
        s = (s).Union(Dafny.Set<X>.FromElements((xs).Select(_1601_i)));
        _1601_i = (_1601_i) + (new BigInteger(1));
      }
    }
    public static void SetToUniqueSeqConstruct<X>(Dafny.Set<X> s, out Dafny.Sequence<X> xs)
    {
      ...
      _1602_arr = _nw8;
      Dafny.Set<X> _1603_s1;
      _1603_s1 = s;
      { }
      { }
      { }
      while ((new BigInteger((_1603_s1).Count)) != (new BigInteger(0))) {
        { }
        { }
        X _1604_x;
        foreach (var _assign_such_that_0 in (_1603_s1).Elements) { _1604_x = _assign_such_that_0;
          if ((_1603_s1).Contains(_1604_x)) {
      ...
      after__ASSIGN_SUCH_THAT_0: ;
        { }
        { }
        var _index7 = (new BigInteger((s).Count)) - (new BigInteger((_1603_s1).Count));
        (_1602_arr)[(int)(_index7)] = _1604_x;
        _1603_s1 = (_1603_s1).Difference(Dafny.Set<X>.FromElements(_1604_x));
        { }
        { }
        { }
      }
      xs = Dafny.Helpers.SeqFromArray(_1602_arr);
      { }
    }
    public static void SubsequenceConstruct<X>(Dafny.Sequence<X> xs, Func<X,bool> f, out Dafny.Sequence<X> xs_k)
    {
      ...
      _1605_arr = _nw9;
      BigInteger _1606_i;
      _1606_i = new BigInteger(0);
      BigInteger _1607_j;
      _1607_j = new BigInteger(0);
      while ((_1606_i) < (new BigInteger((xs).Count))) {
        { }
        { }
        if (Dafny.Helpers.Id<Func<X,bool>>(f)((xs).Select(_1606_i))) {
          { }
          (_1605_arr)[(int)((_1607_j))] = (xs).Select(_1606_i);
          _1607_j = (_1607_j) + (new BigInteger(1));
          { }
        }
        _1606_i = (_1606_i) + (new BigInteger(1));
        { }
      }
      xs_k = Dafny.Helpers.SeqFromArray(_1605_arr).Take(_1607_j);
    }
    ...
    TAIL_CALL_START: ;
      xs_k = Dafny.Sequence<X>.Empty;
      Dafny.Set<X> _1608_s;
      _1608_s = ((System.Func<Dafny.Set<X>>)(() => {
        var _coll2 = new System.Collections.Generic.List<X>();
        foreach (var _compr_1 in (xs).Elements) { X _1609_x = (X)_compr_1;
          if (((xs).Contains(_1609_x)) && (Dafny.Helpers.Id<Func<X,bool>>(f)(_1609_x))) {
            _coll2.Add(_1609_x);
          }
        }
      ...
      _148_Common____SeqIsUnique__i_Compile.__default.SetToUniqueSeqConstruct<X>(_1608_s, out _out106);
      xs_k = _out106;
    }
    public static Dafny.Sequence<X> AppendToUniqueSeq<X>(Dafny.Sequence<X> xs, X x)
    {
      Dafny.Sequence<X> _1610_xs_k = (xs).Concat(Dafny.Sequence<X>.FromElements(x));
      return _1610_xs_k;
    }
    public static Dafny.Sequence<X> AppendToUniqueSeqMaybe<X>(Dafny.Sequence<X> xs, X x)
    {
      if ((xs).Contains(x)) {
        ...
        Dafny.Sequence<X> _1611_xs_k = (xs).Concat(Dafny.Sequence<X>.FromElements(x));
        return _1611_xs_k;
      }
    }
  }
...
namespace _168_Main__i_Compile {
  ...
  public partial class __default {
    public static void _default_Main(out BigInteger exitCode)
    {
      ...
      bool _1612_ok;
      _131_Host__i_Compile.CScheduler _1613_host__state;
      Dafny.Sequence<_9_Native____Io__s_Compile.EndPoint> _1614_config;
      _9_Native____Io__s_Compile.EndPoint _1615_id;
      bool _out107;
      ...
      _1612_ok = _out107;
      _1613_host__state = _out108;
      _1614_config = _out109;
      _1615_id = _out110;
      { }
      while (_1612_ok) {
        { }
        ...
        _131_Host__i_Compile.__default.HostNextImpl(_1613_host__state, out _out111, out _out112);
        _1612_ok = _out111;
        _1613_host__state = _out112;
        { }
      }
    }
  }
