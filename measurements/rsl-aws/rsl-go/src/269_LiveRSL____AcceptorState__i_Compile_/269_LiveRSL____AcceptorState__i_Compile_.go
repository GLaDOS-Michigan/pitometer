// Package _269_LiveRSL____AcceptorState__i_Compile
// Dafny module _269_LiveRSL____AcceptorState__i_Compile compiled into Go
...
// Definition of data type AcceptorState
type AcceptorState struct {
  Data_AcceptorState_
}

func (_this AcceptorState) Get() Data_AcceptorState_ {
  return _this.Data_AcceptorState_
}

type Data_AcceptorState_ interface {
  isAcceptorState()
}

type CompanionStruct_AcceptorState_ struct {}
var Companion_AcceptorState_ = CompanionStruct_AcceptorState_{}

type AcceptorState_AcceptorState struct {
  Constants _245_LiveRSL____ReplicaConstantsState__i_Compile.ReplicaConstantsState
MaxBallot _214_LiveRSL____CTypes__i_Compile.CBallot
...
MinVotedOpn _214_LiveRSL____CTypes__i_Compile.COperationNumber
}

func (AcceptorState_AcceptorState) isAcceptorState() {}

func (CompanionStruct_AcceptorState_) Create_AcceptorState_(Constants _245_LiveRSL____ReplicaConstantsState__i_Compile.ReplicaConstantsState, MaxBallot _214_LiveRSL____CTypes__i_Compile.CBallot, Votes _214_LiveRSL____CTypes__i_Compile.CVotes, Last__checkpointed__operation _dafny.Seq, Log__truncation__point _214_LiveRSL____CTypes__i_Compile.COperationNumber, MinVotedOpn _214_LiveRSL____CTypes__i_Compile.COperationNumber) AcceptorState {
  return AcceptorState{AcceptorState_AcceptorState{Constants,MaxBallot,Votes,Last__checkpointed__operation,Log__truncation__point,MinVotedOpn}}
}

func (_this AcceptorState) Is_AcceptorState() bool {
  _, ok := _this.Get().(AcceptorState_AcceptorState)
return ok
}

func (_this AcceptorState) Dtor_constants() _245_LiveRSL____ReplicaConstantsState__i_Compile.ReplicaConstantsState {
  return _this.Get().(AcceptorState_AcceptorState).Constants
}

func (_this AcceptorState) Dtor_maxBallot() _214_LiveRSL____CTypes__i_Compile.CBallot {
  return _this.Get().(AcceptorState_AcceptorState).MaxBallot
}

func (_this AcceptorState) Dtor_votes() _214_LiveRSL____CTypes__i_Compile.CVotes {
  return _this.Get().(AcceptorState_AcceptorState).Votes
}

func (_this AcceptorState) Dtor_last__checkpointed__operation() _dafny.Seq {
  return _this.Get().(AcceptorState_AcceptorState).Last__checkpointed__operation
}

func (_this AcceptorState) Dtor_log__truncation__point() _214_LiveRSL____CTypes__i_Compile.COperationNumber {
  return _this.Get().(AcceptorState_AcceptorState).Log__truncation__point
}

func (_this AcceptorState) Dtor_minVotedOpn() _214_LiveRSL____CTypes__i_Compile.COperationNumber {
  return _this.Get().(AcceptorState_AcceptorState).MinVotedOpn
}

func (_this AcceptorState) String() string {
  switch data := _this.Get().(type) {
    case nil: return "null"
case AcceptorState_AcceptorState: {
      return "_269_LiveRSL____AcceptorState__i_Compile.AcceptorState.AcceptorState" + "(" + _dafny.String(data.Constants) + ", " + _dafny.String(data.MaxBallot) + ", " + _dafny.String(data.Votes) + ", " + _dafny.String(data.Last__checkpointed__operation) + ", " + _dafny.String(data.Log__truncation__point) + ", " + _dafny.String(data.MinVotedOpn) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this AcceptorState) Equals(other AcceptorState) bool {
  switch data1 := _this.Get().(type) {
    case AcceptorState_AcceptorState: {
      data2, ok := other.Get().(AcceptorState_AcceptorState)
return ok && data1.Constants.Equals(data2.Constants) && data1.MaxBallot.Equals(data2.MaxBallot) && data1.Votes.Equals(data2.Votes) && data1.Last__checkpointed__operation.Equals(data2.Last__checkpointed__operation) && data1.Log__truncation__point.Equals(data2.Log__truncation__point) && data1.MinVotedOpn.Equals(data2.MinVotedOpn)
    }
    default: {
...
func (_this AcceptorState) EqualsGeneric(other interface{}) bool {
  typed, ok := other.(AcceptorState)
return ok && _this.Equals(typed)
}
func Type_AcceptorState_() _dafny.Type {
  return type_AcceptorState_{}
}

type type_AcceptorState_ struct {
}

func (_this type_AcceptorState_) Default() interface{} {
  return AcceptorState{AcceptorState_AcceptorState{_245_LiveRSL____ReplicaConstantsState__i_Compile.Type_ReplicaConstantsState_().Default().(_245_LiveRSL____ReplicaConstantsState__i_Compile.ReplicaConstantsState), _214_LiveRSL____CTypes__i_Compile.Type_CBallot_().Default().(_214_LiveRSL____CTypes__i_Compile.CBallot), _214_LiveRSL____CTypes__i_Compile.Type_CVotes_().Default().(_214_LiveRSL____CTypes__i_Compile.CVotes), _dafny.EmptySeq, _214_LiveRSL____CTypes__i_Compile.Type_COperationNumber_().Default().(_214_LiveRSL____CTypes__i_Compile.COperationNumber), _214_LiveRSL____CTypes__i_Compile.Type_COperationNumber_().Default().(_214_LiveRSL____CTypes__i_Compile.COperationNumber)}}
}

func (_this type_AcceptorState_) String() string {
  return "_269_LiveRSL____AcceptorState__i_Compile.AcceptorState"
}
// End of data type AcceptorState
