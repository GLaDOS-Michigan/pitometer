...
func (_this type_LS__State_) String() string {
  return "_152_DistributedSystem__i_Compile.LS__State"
}
...
type GLS__State_GLS__State struct {
  Ls _152_DistributedSystem__i_Compile.LS__State
History _dafny.Seq
}

func (GLS__State_GLS__State) isGLS__State() {}

func (CompanionStruct_GLS__State_) Create_GLS__State_(Ls _152_DistributedSystem__i_Compile.LS__State, History _dafny.Seq) GLS__State {
...
func (_this GLS__State) Dtor_ls() _152_DistributedSystem__i_Compile.LS__State {
...
func (_this type_GLS__State_) Default() interface{} {
  return GLS__State{GLS__State_GLS__State{Type_LS__State_().Default().(_152_DistributedSystem__i_Compile.LS__State), _dafny.EmptySeq}}
}
