// Package _180_Common____UdpClient__i_Compile
// Dafny module _180_Common____UdpClient__i_Compile compiled into Go
...
func (*Default__) String() string {
  return "_180_Common____UdpClient__i_Compile.Default__"
}
