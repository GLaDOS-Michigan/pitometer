...
END = datetime.fromisoformat("2021-12-18 19:00:00")
...
def main(exp_dir):
    ...
    """
    total_node_data[f][node_id][method_name][t] = list of durations
    ...
    plot_distributions("Paxos Distributions (simple, NA)", exp_dir, total_network_data, total_node_data, total_client_train_data, total_client_data)
