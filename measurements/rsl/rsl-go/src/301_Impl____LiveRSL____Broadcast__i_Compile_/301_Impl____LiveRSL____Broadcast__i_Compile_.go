...
var broadcast _217_LiveRSL____CMessage__i_Compile.CBroadcast = _217_LiveRSL____CMessage__i_Compile.Type_CBroadcast_().Default().(_217_LiveRSL____CMessage__i_Compile.CBroadcast)
  var _ = broadcast
  broadcast = _217_LiveRSL____CMessage__i_Compile.CBroadcast{_217_LiveRSL____CMessage__i_Compile.CBroadcast_CBroadcast{((config).Dtor_replica__ids()).Index(my__index).(_9_Native____Io__s_Compile.EndPoint), (config).Dtor_replica__ids(), msg}}
  return broadcast
}
