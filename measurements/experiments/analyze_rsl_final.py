...
def plot_distributions_ax(f, this_ax, name, actual_client_latencies, actual_network_latencies, actual_method_latencies):
    ...
    # print(predict_cdf)
    # print(predict_cdf2)
    xdiff = [abs(predict_cdf[i]-predict_cdf2[i])/predict_cdf[i]*100 for i in range(len(predict_cdf2))]
    print()
    print()
    print()
    print(np.percentile(xdiff, 100))
    print(np.percentile(xdiff, 99.5))
    print(np.percentile(xdiff, 99))
    print(np.percentile(xdiff, 98.5))
    print(np.percentile(xdiff, 98))
    print()
    print(np.percentile(xdiff, 0.5))
    print(np.percentile(xdiff, 0))
    print()
    print()
    print()
