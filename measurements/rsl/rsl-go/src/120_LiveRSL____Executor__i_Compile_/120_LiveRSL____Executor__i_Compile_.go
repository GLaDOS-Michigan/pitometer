...
Next__op__to__execute _120_LiveRSL____Executor__i_Compile.OutstandingOperation
Reply__cache _dafny.Map
}

func (LExecutor_LExecutor) isLExecutor() {}

func (CompanionStruct_LExecutor_) Create_LExecutor_(Constants _78_LiveRSL____Constants__i_Compile.LReplicaConstants, App uint64, Ops__complete _dafny.Int, Max__bal__reflected _56_LiveRSL____Types__i_Compile.Ballot, Next__op__to__execute _120_LiveRSL____Executor__i_Compile.OutstandingOperation, Reply__cache _dafny.Map) LExecutor {
...
func (_this LExecutor) Dtor_next__op__to__execute() _120_LiveRSL____Executor__i_Compile.OutstandingOperation {
