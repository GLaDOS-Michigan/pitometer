...
func (CompanionStruct_LScheduler_) Create_LScheduler_(Replica LReplica, NextActionIndex _dafny.Int) LScheduler {
...
func (_this LScheduler) Dtor_replica() LReplica {
...
func (_this type_LScheduler_) Default() interface{} {
	return LScheduler{LScheduler_LScheduler{Type_LReplica_().Default().(LReplica), _dafny.Zero}}
}
