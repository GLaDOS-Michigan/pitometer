...
func (_this *CompanionStruct_Default___) SeqByteToUint64(bs _dafny.Seq) uint64 {
	_, isInt := (bs).IndexUint(uint64(0)).(int)
	if isInt {
		return (((((((((((uint64((bs).IndexUint(uint64(0)).(int))) * (uint64(256))) * (uint64(256))) * (uint64(256))) * (uint64(4294967296))) + ((((uint64((bs).IndexUint(uint64(1)).(int))) * (uint64(256))) * (uint64(256))) * (uint64(4294967296)))) + (((uint64((bs).IndexUint(uint64(2)).(int))) * (uint64(256))) * (uint64(4294967296)))) + ((uint64((bs).IndexUint(uint64(3)).(int))) * (uint64(4294967296)))) + ((((uint64((bs).IndexUint(uint64(4)).(int))) * (uint64(256))) * (uint64(256))) * (uint64(256)))) + (((uint64((bs).IndexUint(uint64(5)).(int))) * (uint64(256))) * (uint64(256)))) + ((uint64((bs).IndexUint(uint64(6)).(int))) * (uint64(256)))) + (uint64((bs).IndexUint(uint64(7)).(int)))
	} else {
