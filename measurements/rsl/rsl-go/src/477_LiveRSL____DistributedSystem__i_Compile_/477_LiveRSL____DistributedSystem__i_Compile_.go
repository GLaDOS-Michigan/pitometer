// Package _477_LiveRSL____DistributedSystem__i_Compile
// Dafny module _477_LiveRSL____DistributedSystem__i_Compile compiled into Go
...
// Definition of data type RslState
type RslState struct {
  Data_RslState_
}

func (_this RslState) Get() Data_RslState_ {
  return _this.Data_RslState_
}

type Data_RslState_ interface {
  isRslState()
}

type CompanionStruct_RslState_ struct {}
var Companion_RslState_ = CompanionStruct_RslState_{}

type RslState_RslState struct {
  Constants _78_LiveRSL____Constants__i_Compile.LConstants
Environment _7_Environment__s_Compile.LEnvironment
Replicas _dafny.Seq
Clients _dafny.Set
}

func (RslState_RslState) isRslState() {}

func (CompanionStruct_RslState_) Create_RslState_(Constants _78_LiveRSL____Constants__i_Compile.LConstants, Environment _7_Environment__s_Compile.LEnvironment, Replicas _dafny.Seq, Clients _dafny.Set) RslState {
  return RslState{RslState_RslState{Constants,Environment,Replicas,Clients}}
}

func (_this RslState) Is_RslState() bool {
  _, ok := _this.Get().(RslState_RslState)
return ok
}

func (_this RslState) Dtor_constants() _78_LiveRSL____Constants__i_Compile.LConstants {
  return _this.Get().(RslState_RslState).Constants
}

func (_this RslState) Dtor_environment() _7_Environment__s_Compile.LEnvironment {
  return _this.Get().(RslState_RslState).Environment
}

func (_this RslState) Dtor_replicas() _dafny.Seq {
  return _this.Get().(RslState_RslState).Replicas
}

func (_this RslState) Dtor_clients() _dafny.Set {
  return _this.Get().(RslState_RslState).Clients
}

func (_this RslState) String() string {
  switch data := _this.Get().(type) {
    case nil: return "null"
case RslState_RslState: {
      return "_477_LiveRSL____DistributedSystem__i_Compile.RslState.RslState" + "(" + _dafny.String(data.Constants) + ", " + _dafny.String(data.Environment) + ", " + _dafny.String(data.Replicas) + ", " + _dafny.String(data.Clients) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this RslState) Equals(other RslState) bool {
  switch data1 := _this.Get().(type) {
    case RslState_RslState: {
      data2, ok := other.Get().(RslState_RslState)
return ok && data1.Constants.Equals(data2.Constants) && data1.Environment.Equals(data2.Environment) && data1.Replicas.Equals(data2.Replicas) && data1.Clients.Equals(data2.Clients)
    }
    default: {
...
func (_this RslState) EqualsGeneric(other interface{}) bool {
  typed, ok := other.(RslState)
return ok && _this.Equals(typed)
}
func Type_RslState_() _dafny.Type {
  return type_RslState_{}
}

type type_RslState_ struct {
}

func (_this type_RslState_) Default() interface{} {
  return RslState{RslState_RslState{_78_LiveRSL____Constants__i_Compile.Type_LConstants_().Default().(_78_LiveRSL____Constants__i_Compile.LConstants), _7_Environment__s_Compile.Type_LEnvironment_().Default().(_7_Environment__s_Compile.LEnvironment), _dafny.EmptySeq, _dafny.EmptySet}}
}

func (_this type_RslState_) String() string {
  return "_477_LiveRSL____DistributedSystem__i_Compile.RslState"
}
// End of data type RslState
