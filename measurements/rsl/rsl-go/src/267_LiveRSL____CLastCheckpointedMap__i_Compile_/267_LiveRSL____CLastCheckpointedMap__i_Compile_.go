// Package _267_LiveRSL____CLastCheckpointedMap__i_Compile
// Dafny module _267_LiveRSL____CLastCheckpointedMap__i_Compile compiled into Go
...
func (*Default__) String() string {
  return "_267_LiveRSL____CLastCheckpointedMap__i_Compile.Default__"
}
...
func (_this *CompanionStruct_Default___) SeqToArray(Type_T_ _dafny.Type, s _dafny.Seq) *_dafny.Array {
  goto TAIL_CALL_START
TAIL_CALL_START:
var a *_dafny.Array = _dafny.NewArrayWithValue(Type_T_.Default(), _dafny.IntOf(0))
  var _ = a
  var _nw10 = _dafny.NewArrayWithValue(Type_T_.Default(), (s).Cardinality())
  var _ = _nw10
  a = _nw10
  var _4739_i _dafny.Int
  var _ = _4739_i
  _4739_i = _dafny.Zero
  for (_4739_i).Cmp((s).Cardinality()) < 0 {
    *((a).Index(_dafny.IntOfAny((_4739_i)))) = (s).Index(_4739_i).(interface{})
    _4739_i = (_4739_i).Plus(_dafny.IntOfInt64(1))
  }
  return a
}
func (_this *CompanionStruct_Default___) ComputeNthHighestValue(cm _dafny.Seq, n uint64) _214_LiveRSL____CTypes__i_Compile.COperationNumber {
  ...
  var _ = opn
  var _4740_a *_dafny.Array
  var _ = _4740_a
var _out140 *_dafny.Array
  var _ = _out140
_out140 = Companion_Default___.SeqToArray(_214_LiveRSL____CTypes__i_Compile.Type_COperationNumber_(), cm)
_4740_a = _out140
  { }
  _265_LiveRSL____COperationNumberSort__i_Compile.Companion_Default___.InsertionSortCOperationNumbers(_4740_a)
  { }
  { }
  { }
  opn = (*(_4740_a).Index((((_4740_a).Len(0)).Minus(_dafny.IntOfUint64(n))))).(_214_LiveRSL____CTypes__i_Compile.COperationNumber)
  { }
  { }
  { }
  { }
