...
TAIL_CALL_START:
  ...
  for (_4737_i) < (uint64((a).LenInt(0))) {
    ...
    var _ = _4738_j
    _4738_j = _4737_i
    for ((uint64(0)) < (_4738_j)) && ((((*(a).Index(((_4738_j) - (func () uint64 { return  (uint64(1)) })()))).(_214_LiveRSL____CTypes__i_Compile.COperationNumber)).Dtor_n()) > (((*(a).Index((_4738_j))).(_214_LiveRSL____CTypes__i_Compile.COperationNumber)).Dtor_n())) {
      var _index8 = (_4738_j) - (func () uint64 { return  (uint64(1)) })()
      var _ = _index8
      *((a).Index(_dafny.IntOfAny((_4738_j)))), *((a).Index(_dafny.IntOfAny(_index8))) = (*(a).Index(((_4738_j) - (func () uint64 { return  (uint64(1)) })()))).(_214_LiveRSL____CTypes__i_Compile.COperationNumber), (*(a).Index((_4738_j))).(_214_LiveRSL____CTypes__i_Compile.COperationNumber)
