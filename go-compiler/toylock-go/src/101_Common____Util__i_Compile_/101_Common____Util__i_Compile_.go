...
func (_this *CompanionStruct_Default___) SeqByteToUint64(bs _dafny.Seq) uint64 {
	return (((((((((((uint64((bs).Index(_dafny.IntOfAny(uint64(0))).(uint8))) * (uint64(256))) * (uint64(256))) * (uint64(256))) * (uint64(4294967296))) + ((((uint64((bs).Index(_dafny.IntOfAny(uint64(1))).(uint8))) * (uint64(256))) * (uint64(256))) * (uint64(4294967296)))) + (((uint64((bs).Index(_dafny.IntOfAny(uint64(2))).(uint8))) * (uint64(256))) * (uint64(4294967296)))) + ((uint64((bs).Index(_dafny.IntOfAny(uint64(3))).(uint8))) * (uint64(4294967296)))) + ((((uint64((bs).Index(_dafny.IntOfAny(uint64(4))).(uint8))) * (uint64(256))) * (uint64(256))) * (uint64(256)))) + (((uint64((bs).Index(_dafny.IntOfAny(uint64(5))).(uint8))) * (uint64(256))) * (uint64(256)))) + ((uint64((bs).Index(_dafny.IntOfAny(uint64(6))).(uint8))) * (uint64(256)))) + (uint64((bs).Index(_dafny.IntOfAny(uint64(7))).(uint8)))
}
