// Package _245_LiveRSL____ReplicaConstantsState__i_Compile
// Dafny module _245_LiveRSL____ReplicaConstantsState__i_Compile compiled into Go
...
// Definition of data type ReplicaConstantsState
type ReplicaConstantsState struct {
  Data_ReplicaConstantsState_
}

func (_this ReplicaConstantsState) Get() Data_ReplicaConstantsState_ {
  return _this.Data_ReplicaConstantsState_
}

type Data_ReplicaConstantsState_ interface {
  isReplicaConstantsState()
}

type CompanionStruct_ReplicaConstantsState_ struct {}
var Companion_ReplicaConstantsState_ = CompanionStruct_ReplicaConstantsState_{}

type ReplicaConstantsState_ReplicaConstantsState struct {
  My__index uint64
All _240_LiveRSL____ConstantsState__i_Compile.ConstantsState
}

func (ReplicaConstantsState_ReplicaConstantsState) isReplicaConstantsState() {}

func (CompanionStruct_ReplicaConstantsState_) Create_ReplicaConstantsState_(My__index uint64, All _240_LiveRSL____ConstantsState__i_Compile.ConstantsState) ReplicaConstantsState {
  return ReplicaConstantsState{ReplicaConstantsState_ReplicaConstantsState{My__index,All}}
}

func (_this ReplicaConstantsState) Is_ReplicaConstantsState() bool {
  _, ok := _this.Get().(ReplicaConstantsState_ReplicaConstantsState)
return ok
}

func (_this ReplicaConstantsState) Dtor_my__index() uint64 {
  return _this.Get().(ReplicaConstantsState_ReplicaConstantsState).My__index
}

func (_this ReplicaConstantsState) Dtor_all() _240_LiveRSL____ConstantsState__i_Compile.ConstantsState {
  return _this.Get().(ReplicaConstantsState_ReplicaConstantsState).All
}

func (_this ReplicaConstantsState) String() string {
  switch data := _this.Get().(type) {
    case nil: return "null"
case ReplicaConstantsState_ReplicaConstantsState: {
      return "_245_LiveRSL____ReplicaConstantsState__i_Compile.ReplicaConstantsState.ReplicaConstantsState" + "(" + _dafny.String(data.My__index) + ", " + _dafny.String(data.All) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this ReplicaConstantsState) Equals(other ReplicaConstantsState) bool {
  switch data1 := _this.Get().(type) {
    case ReplicaConstantsState_ReplicaConstantsState: {
      data2, ok := other.Get().(ReplicaConstantsState_ReplicaConstantsState)
return ok && data1.My__index == data2.My__index && data1.All.Equals(data2.All)
    }
    default: {
...
func (_this ReplicaConstantsState) EqualsGeneric(other interface{}) bool {
  typed, ok := other.(ReplicaConstantsState)
return ok && _this.Equals(typed)
}
func Type_ReplicaConstantsState_() _dafny.Type {
  return type_ReplicaConstantsState_{}
}

type type_ReplicaConstantsState_ struct {
}

func (_this type_ReplicaConstantsState_) Default() interface{} {
  return ReplicaConstantsState{ReplicaConstantsState_ReplicaConstantsState{0, _240_LiveRSL____ConstantsState__i_Compile.Type_ConstantsState_().Default().(_240_LiveRSL____ConstantsState__i_Compile.ConstantsState)}}
}

func (_this type_ReplicaConstantsState_) String() string {
  return "_245_LiveRSL____ReplicaConstantsState__i_Compile.ReplicaConstantsState"
}
// End of data type ReplicaConstantsState
...
func (*Default__) String() string {
  return "_245_LiveRSL____ReplicaConstantsState__i_Compile.Default__"
}
...
func (_this *CompanionStruct_Default___) InitReplicaConstantsState(endPoint _9_Native____Io__s_Compile.EndPoint, config _238_LiveRSL____CPaxosConfiguration__i_Compile.CPaxosConfiguration) _245_LiveRSL____ReplicaConstantsState__i_Compile.ReplicaConstantsState {
  goto TAIL_CALL_START
TAIL_CALL_START:
var rc _245_LiveRSL____ReplicaConstantsState__i_Compile.ReplicaConstantsState = Type_ReplicaConstantsState_().Default().(_245_LiveRSL____ReplicaConstantsState__i_Compile.ReplicaConstantsState)
  var _ = rc
  var _4733_params _236_LiveRSL____ParametersState__i_Compile.ParametersState
  var _ = _4733_params
  _4733_params = _236_LiveRSL____ParametersState__i_Compile.Companion_Default___.StaticParams()
  var _4734_constants _240_LiveRSL____ConstantsState__i_Compile.ConstantsState
  var _ = _4734_constants
  _4734_constants = _240_LiveRSL____ConstantsState__i_Compile.ConstantsState{_240_LiveRSL____ConstantsState__i_Compile.ConstantsState_ConstantsState{config, _4733_params}}
  var _4735_found bool
  var _ = _4735_found
var _4736_index uint64
  var _ = _4736_index
var _out138 bool
  var _ = _out138
var _out139 uint64
  var _ = _out139
_out138,_out139 = _238_LiveRSL____CPaxosConfiguration__i_Compile.Companion_Default___.CGetReplicaIndex(endPoint, config)
_4735_found = _out138
_4736_index = _out139
  rc = ReplicaConstantsState{ReplicaConstantsState_ReplicaConstantsState{_4736_index, _4734_constants}}
  return rc
}
