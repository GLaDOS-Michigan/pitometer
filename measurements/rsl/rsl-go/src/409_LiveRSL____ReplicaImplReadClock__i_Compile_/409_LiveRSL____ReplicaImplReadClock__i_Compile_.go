// Package _409_LiveRSL____ReplicaImplReadClock__i_Compile
// Dafny module _409_LiveRSL____ReplicaImplReadClock__i_Compile compiled into Go
...
func (*Default__) String() string {
  return "_409_LiveRSL____ReplicaImplReadClock__i_Compile.Default__"
}
...
func (_this *CompanionStruct_Default___) Replica__Next__ReadClockAndProcessPacket(r *_383_LiveRSL____ReplicaImplClass__i_Compile.ReplicaImpl, cpacket _217_LiveRSL____CMessage__i_Compile.CPacket) bool {
  var ok bool = false
  var _ = ok
  var _5249_clock _283_LiveRSL____CClockReading__i_Compile.CClockReading
  var _ = _5249_clock
var _out428 _283_LiveRSL____CClockReading__i_Compile.CClockReading
  var _ = _out428
_out428 = _368_LiveRSL____UdpRSL__i_Compile.Companion_Default___.ReadClock(r.UdpClient)
_5249_clock = _out428
  { }
  { }
  { }
  var _5250_sent__packets _217_LiveRSL____CMessage__i_Compile.OutboundPackets = _217_LiveRSL____CMessage__i_Compile.Type_OutboundPackets_().Default().(_217_LiveRSL____CMessage__i_Compile.OutboundPackets)
  var _ = _5250_sent__packets
  var _out429 _285_LiveRSL____ReplicaState__i_Compile.ReplicaState
  var _ = _out429
var _out430 _217_LiveRSL____CMessage__i_Compile.OutboundPackets
  var _ = _out430
_out429,_out430 = _347_LiveRSL____ReplicaModel__Part4__i_Compile.Companion_Default___.Replica__Next__Process__Heartbeat(r.Replica, cpacket, (_5249_clock).Dtor_t(), r.Cur__req__set, r.Prev__req__set)
(r).Replica = _out429
_5250_sent__packets = _out430
  { }
  { }
  var _out431 bool
  var _ = _out431
_out431 = _405_LiveRSL____ReplicaImplDelivery__i_Compile.Companion_Default___.DeliverOutboundPackets(r, _5250_sent__packets)
ok = _out431
  if (!(ok)) {
    return ok
  }
