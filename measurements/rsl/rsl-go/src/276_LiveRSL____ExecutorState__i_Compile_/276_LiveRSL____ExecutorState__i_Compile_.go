...
case COutstandingOperation_COutstandingOpKnown: {
      return "_276_LiveRSL____ExecutorState__i_Compile.COutstandingOperation.COutstandingOpKnown" + "(" + _dafny.String(data.V) + ", " + _dafny.String(data.Bal) + ")"
    }
    case COutstandingOperation_COutstandingOpUnknown: {
      return "_276_LiveRSL____ExecutorState__i_Compile.COutstandingOperation.COutstandingOpUnknown"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this type_COutstandingOperation_) String() string {
  return "_276_LiveRSL____ExecutorState__i_Compile.COutstandingOperation"
}
...
Next__op__to__execute _276_LiveRSL____ExecutorState__i_Compile.COutstandingOperation
}

func (ExecutorState_ExecutorState) isExecutorState() {}

func (CompanionStruct_ExecutorState_) Create_ExecutorState_(Constants _245_LiveRSL____ReplicaConstantsState__i_Compile.ReplicaConstantsState, App uint64, Ops__complete _214_LiveRSL____CTypes__i_Compile.COperationNumber, Max__bal__reflected _214_LiveRSL____CTypes__i_Compile.CBallot, Next__op__to__execute _276_LiveRSL____ExecutorState__i_Compile.COutstandingOperation) ExecutorState {
...
func (_this ExecutorState) Dtor_next__op__to__execute() _276_LiveRSL____ExecutorState__i_Compile.COutstandingOperation {
...
case ExecutorState_ExecutorState: {
      return "_276_LiveRSL____ExecutorState__i_Compile.ExecutorState.ExecutorState" + "(" + _dafny.String(data.Constants) + ", " + _dafny.String(data.App) + ", " + _dafny.String(data.Ops__complete) + ", " + _dafny.String(data.Max__bal__reflected) + ", " + _dafny.String(data.Next__op__to__execute) + ")"
    }
    default: {
      return "<unexpected>"
    }
