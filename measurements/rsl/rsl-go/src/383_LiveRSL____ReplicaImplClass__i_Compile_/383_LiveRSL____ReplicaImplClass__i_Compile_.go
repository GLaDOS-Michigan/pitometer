...
var client *_9_Native____Io__s_Compile.UdpClient = (*_9_Native____Io__s_Compile.UdpClient)(nil)
  ...
  var _ = _5237_my__ep
  _5237_my__ep = ((((constants).Dtor_all()).Dtor_config()).Dtor_replica__ids()).Index((constants).Dtor_my__index()).(_9_Native____Io__s_Compile.EndPoint)
...
(_this).Reply__cache__mutable = _out415
    ...
    (_this).LocalAddr = (((((_this.Replica).Dtor_constants()).Dtor_all()).Dtor_config()).Dtor_replica__ids()).Index(((_this.Replica).Dtor_constants()).Dtor_my__index()).(_9_Native____Io__s_Compile.EndPoint)
    { }
