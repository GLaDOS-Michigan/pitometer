...
func (_this *CompanionStruct_Default___) ReplicaNoReceiveReadClockNextMaybeNominateValueAndSend2a(r *_383_LiveRSL____ReplicaImplClass__i_Compile.ReplicaImpl) bool {
  var ok bool = false
  var _ = ok
  { }
...
var _out494 _217_LiveRSL____CMessage__i_Compile.OutboundPackets
  var _ = _out494
_out493,_out494 = _339_LiveRSL____ReplicaModel__Part3__i_Compile.Companion_Default___.Replica__Next__Spontaneous__MaybeNominateValueAndSend2a(r.Replica, _5270_clock)
(r).Replica = _out493
...
func (_this *CompanionStruct_Default___) ReplicaNoReceiveReadClockNextCheckForViewTimeout(r *_383_LiveRSL____ReplicaImplClass__i_Compile.ReplicaImpl) bool {
  var ok bool = false
  var _ = ok
  { }
...
func (_this *CompanionStruct_Default___) ReplicaNoReceiveReadClockNextCheckForQuorumOfViewSuspicions(r *_383_LiveRSL____ReplicaImplClass__i_Compile.ReplicaImpl) bool {
  var ok bool = false
  var _ = ok
  { }
...
func (_this *CompanionStruct_Default___) ReplicaNoReceiveReadClockNextMaybeSendHeartbat(r *_383_LiveRSL____ReplicaImplClass__i_Compile.ReplicaImpl) bool {
  var ok bool = false
  var _ = ok
  { }
...
func (_this *CompanionStruct_Default___) Replica__NoReceive__ReadClock__Next(r *_383_LiveRSL____ReplicaImplClass__i_Compile.ReplicaImpl) bool {
...
var ok bool = false
  ...
  if ((r.NextActionIndex) == (uint64(3))) {
    var _out508 bool
    var _ = _out508
_out508 = Companion_Default___.ReplicaNoReceiveReadClockNextMaybeNominateValueAndSend2a(r)
ok = _out508
  } else if ((r.NextActionIndex) == (uint64(7))) {
    var _out509 bool
    var _ = _out509
_out509 = Companion_Default___.ReplicaNoReceiveReadClockNextCheckForViewTimeout(r)
ok = _out509
  } else if ((r.NextActionIndex) == (uint64(8))) {
    var _out510 bool
    var _ = _out510
_out510 = Companion_Default___.ReplicaNoReceiveReadClockNextCheckForQuorumOfViewSuspicions(r)
ok = _out510
  } else if ((r.NextActionIndex) == (uint64(9))) {
    var _out511 bool
    var _ = _out511
_out511 = Companion_Default___.ReplicaNoReceiveReadClockNextMaybeSendHeartbat(r)
ok = _out511
  }
  return ok
}
