...
case CBallot_CBallot: {
      return "_214_LiveRSL____CTypes__i_Compile.CBallot.CBallot" + "(" + _dafny.String(data.Seqno) + ", " + _dafny.String(data.Proposer__id) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this type_CBallot_) String() string {
  return "_214_LiveRSL____CTypes__i_Compile.CBallot"
}
...
case COperationNumber_COperationNumber: {
      return "_214_LiveRSL____CTypes__i_Compile.COperationNumber.COperationNumber" + "(" + _dafny.String(data.N) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this type_COperationNumber_) String() string {
  return "_214_LiveRSL____CTypes__i_Compile.COperationNumber"
}
...
case CRequest_CRequest: {
      return "_214_LiveRSL____CTypes__i_Compile.CRequest.CRequest" + "(" + _dafny.String(data.Client) + ", " + _dafny.String(data.Seqno) + ", " + _dafny.String(data.Request) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this type_CRequest_) String() string {
  return "_214_LiveRSL____CTypes__i_Compile.CRequest"
}
...
func (_this CReply) String() string {
  switch data := _this.Get().(type) {
    case nil: return "null"
case CReply_CReply: {
      return "_214_LiveRSL____CTypes__i_Compile.CReply.CReply" + "(" + _dafny.String(data.Client) + ", " + _dafny.String(data.Seqno) + ", " + _dafny.String(data.Reply) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this type_CReply_) String() string {
  return "_214_LiveRSL____CTypes__i_Compile.CReply"
}
...
type CVote_CVote struct {
  Max__value__bal _214_LiveRSL____CTypes__i_Compile.CBallot
Max__val _dafny.Seq
}

func (CVote_CVote) isCVote() {}

func (CompanionStruct_CVote_) Create_CVote_(Max__value__bal _214_LiveRSL____CTypes__i_Compile.CBallot, Max__val _dafny.Seq) CVote {
...
func (_this CVote) Dtor_max__value__bal() _214_LiveRSL____CTypes__i_Compile.CBallot {
...
func (_this CVote) String() string {
  switch data := _this.Get().(type) {
    case nil: return "null"
case CVote_CVote: {
      return "_214_LiveRSL____CTypes__i_Compile.CVote.CVote" + "(" + _dafny.String(data.Max__value__bal) + ", " + _dafny.String(data.Max__val) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this type_CVote_) Default() interface{} {
  return CVote{CVote_CVote{Type_CBallot_().Default().(_214_LiveRSL____CTypes__i_Compile.CBallot), _dafny.EmptySeq}}
}

func (_this type_CVote_) String() string {
  return "_214_LiveRSL____CTypes__i_Compile.CVote"
}
...
func (_this CVotes) String() string {
  switch data := _this.Get().(type) {
    case nil: return "null"
case CVotes_CVotes: {
      return "_214_LiveRSL____CTypes__i_Compile.CVotes.CVotes" + "(" + _dafny.String(data.V) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this type_CVotes_) String() string {
  return "_214_LiveRSL____CTypes__i_Compile.CVotes"
}
...
func (CompanionStruct_OptionOpn_) Create_ExistsOperation_(Opn _214_LiveRSL____CTypes__i_Compile.COperationNumber) OptionOpn {
...
func (_this OptionOpn) Dtor_opn() _214_LiveRSL____CTypes__i_Compile.COperationNumber {
...
case OptionOpn_ExistsOperation: {
      return "_214_LiveRSL____CTypes__i_Compile.OptionOpn.ExistsOperation" + "(" + _dafny.String(data.Opn) + ")"
    }
    case OptionOpn_NotExistsOperation: {
      return "_214_LiveRSL____CTypes__i_Compile.OptionOpn.NotExistsOperation"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this type_OptionOpn_) Default() interface{} {
  return OptionOpn{OptionOpn_ExistsOperation{Type_COperationNumber_().Default().(_214_LiveRSL____CTypes__i_Compile.COperationNumber)}}
}

func (_this type_OptionOpn_) String() string {
  return "_214_LiveRSL____CTypes__i_Compile.OptionOpn"
}
...
func (*Default__) String() string {
  return "_214_LiveRSL____CTypes__i_Compile.Default__"
}
...
func (_this *CompanionStruct_Default___) CBallotIsLessThan(lhs _214_LiveRSL____CTypes__i_Compile.CBallot, rhs _214_LiveRSL____CTypes__i_Compile.CBallot) bool {
  return (((lhs).Dtor_seqno()) < ((rhs).Dtor_seqno())) || ((((lhs).Dtor_seqno()) == ((rhs).Dtor_seqno())) && (((lhs).Dtor_proposer__id()) < ((rhs).Dtor_proposer__id())))
}
func (_this *CompanionStruct_Default___) CBallotIsNotGreaterThan(lhs _214_LiveRSL____CTypes__i_Compile.CBallot, rhs _214_LiveRSL____CTypes__i_Compile.CBallot) bool {
  return (((lhs).Dtor_seqno()) < ((rhs).Dtor_seqno())) || ((((lhs).Dtor_seqno()) == ((rhs).Dtor_seqno())) && (((lhs).Dtor_proposer__id()) <= ((rhs).Dtor_proposer__id())))
}
func (_this *CompanionStruct_Default___) CBalLeq(ba _214_LiveRSL____CTypes__i_Compile.CBallot, bb _214_LiveRSL____CTypes__i_Compile.CBallot) bool {
...
func (_this *CompanionStruct_Default___) CBalLt(ba _214_LiveRSL____CTypes__i_Compile.CBallot, bb _214_LiveRSL____CTypes__i_Compile.CBallot) bool {
  goto TAIL_CALL_START
TAIL_CALL_START:
var b bool = false
  var _ = b
...
func (_this *CompanionStruct_Default___) ValidRequest(c _214_LiveRSL____CTypes__i_Compile.CRequest) bool {
...
func (_this *CompanionStruct_Default___) ValidReply(c _214_LiveRSL____CTypes__i_Compile.CReply) bool {
