// Package _283_LiveRSL____CClockReading__i_Compile
// Dafny module _283_LiveRSL____CClockReading__i_Compile compiled into Go
...
// Definition of data type CClockReading
type CClockReading struct {
  Data_CClockReading_
}

func (_this CClockReading) Get() Data_CClockReading_ {
  return _this.Data_CClockReading_
}

type Data_CClockReading_ interface {
  isCClockReading()
}

type CompanionStruct_CClockReading_ struct {}
var Companion_CClockReading_ = CompanionStruct_CClockReading_{}

type CClockReading_CClockReading struct {
  T uint64
}

func (CClockReading_CClockReading) isCClockReading() {}

func (CompanionStruct_CClockReading_) Create_CClockReading_(T uint64) CClockReading {
  return CClockReading{CClockReading_CClockReading{T}}
}

func (_this CClockReading) Is_CClockReading() bool {
  _, ok := _this.Get().(CClockReading_CClockReading)
return ok
}

func (_this CClockReading) Dtor_t() uint64 {
  return _this.Get().(CClockReading_CClockReading).T
}

func (_this CClockReading) String() string {
  switch data := _this.Get().(type) {
    case nil: return "null"
case CClockReading_CClockReading: {
      return "_283_LiveRSL____CClockReading__i_Compile.CClockReading.CClockReading" + "(" + _dafny.String(data.T) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this CClockReading) Equals(other CClockReading) bool {
  switch data1 := _this.Get().(type) {
    case CClockReading_CClockReading: {
      data2, ok := other.Get().(CClockReading_CClockReading)
return ok && data1.T == data2.T
    }
    default: {
...
func (_this CClockReading) EqualsGeneric(other interface{}) bool {
  typed, ok := other.(CClockReading)
return ok && _this.Equals(typed)
}
func Type_CClockReading_() _dafny.Type {
  return type_CClockReading_{}
}

type type_CClockReading_ struct {
}

func (_this type_CClockReading_) Default() interface{} {
  return CClockReading{CClockReading_CClockReading{0}}
}

func (_this type_CClockReading_) String() string {
  return "_283_LiveRSL____CClockReading__i_Compile.CClockReading"
}
// End of data type CClockReading
