...
type ProposerState_ProposerState struct {
	...
	Incomplete__batch__timer                          CIncompleteBatchTimer
...
func (_this ProposerState) Dtor_incomplete__batch__timer() CIncompleteBatchTimer {
