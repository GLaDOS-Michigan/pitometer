// Package _469_RSL__DistributedSystem__i_Compile
// Dafny module _469_RSL__DistributedSystem__i_Compile compiled into Go
...
type DS__State_DS__State struct {
  Config _240_LiveRSL____ConstantsState__i_Compile.ConstantsState
...
func (CompanionStruct_DS__State_) Create_DS__State_(Config _240_LiveRSL____ConstantsState__i_Compile.ConstantsState, Environment _7_Environment__s_Compile.LEnvironment, Servers _dafny.Map, Clients _dafny.Set) DS__State {
...
func (_this DS__State) Dtor_config() _240_LiveRSL____ConstantsState__i_Compile.ConstantsState {
...
case DS__State_DS__State: {
      return "_469_RSL__DistributedSystem__i_Compile.DS_State.DS_State" + "(" + _dafny.String(data.Config) + ", " + _dafny.String(data.Environment) + ", " + _dafny.String(data.Servers) + ", " + _dafny.String(data.Clients) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this type_DS__State_) Default() interface{} {
  return DS__State{DS__State_DS__State{_240_LiveRSL____ConstantsState__i_Compile.Type_ConstantsState_().Default().(_240_LiveRSL____ConstantsState__i_Compile.ConstantsState), _7_Environment__s_Compile.Type_LEnvironment_().Default().(_7_Environment__s_Compile.LEnvironment), _dafny.EmptyMap, _dafny.EmptySet}}
}

func (_this type_DS__State_) String() string {
  return "_469_RSL__DistributedSystem__i_Compile.DS__State"
}
