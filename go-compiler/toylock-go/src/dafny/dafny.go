...
// IndexUint64 finds the sequence element at the given index.
// TONY
func (seq Seq) IndexUint64(i uint64) interface{} {
	return seq.IndexInt(IntOfUint64(i).Int())
}
...
// CardinalityInt64 finds the length of the sequence as an int.
// TONY
func (seq Seq) CardinalityInt64() uint64 {
