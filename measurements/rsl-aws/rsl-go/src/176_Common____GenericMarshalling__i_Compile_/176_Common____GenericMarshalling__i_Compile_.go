...
func (_this ContentsTraceStep) String() string {
	...
	case ContentsTraceStep_ContentsTraceStep:
		{
			return "ContentsTraceStep.ContentsTraceStep" + "(" + _dafny.String(data.Data) + ", " + _dafny.String(data.Val) + ")"
		}
	default:
		{
			return "<unexpected>"
...
func (_this *CompanionStruct_Default___) Parse__Uint64(data _dafny.Seq) _System.Tuple2 {
	if (uint64((data).CardinalityUint64())) >= (_138_Native____NativeTypes__i_Compile.Companion_Default___.Uint64Size()) {
		return _dafny.TupleOf(
			_135_Logic____Option__i_Compile.Option{_135_Logic____Option__i_Compile.Option_Some{V{V_VUint64{_170_Common____Util__i_Compile.Companion_Default___.SeqByteToUint64((data).Subseq(_dafny.NilInt, _dafny.IntOfAny(_138_Native____NativeTypes__i_Compile.Companion_Default___.Uint64Size())))}}}},
			(data).Subseq(_dafny.IntOfAny(_138_Native____NativeTypes__i_Compile.Companion_Default___.Uint64Size()), _dafny.NilInt))
	} else {
...
TAIL_CALL_START:
	...
	if ((uint64((data).LenInt(0))) >= (uint64(8))) && ((index) <= ((uint64((data).LenInt(0))) - (func() uint64 { return (uint64(8)) })())) {
		...
		var _ = _4541_result
		_4541_result = ((((((((uint64((*(data).IndexUints(((index) + (uint64(0))))).(uint8))) * (uint64(72057594037927936))) + ((uint64((*(data).IndexUints(((index) + (uint64(1))))).(uint8))) * (uint64(281474976710656)))) + ((uint64((*(data).IndexUints(((index) + (uint64(2))))).(uint8))) * (uint64(1099511627776)))) + ((uint64((*(data).IndexUints(((index) + (uint64(3))))).(uint8))) * (uint64(4294967296)))) + ((uint64((*(data).IndexUints(((index) + (uint64(4))))).(uint8))) * (uint64(16777216)))) + ((uint64((*(data).IndexUints(((index) + (uint64(5))))).(uint8))) * (uint64(65536)))) + ((uint64((*(data).IndexUints(((index) + (uint64(6))))).(uint8))) * (uint64(256)))) + (uint64((*(data).IndexUints(((index) + (uint64(7))))).(uint8)))
		success = true
...
func (_this *CompanionStruct_Default___) Parse__Array__contents(data _dafny.Seq, eltType G, len_ uint64) _System.Tuple2 {
	if (len_) == (uint64(0)) {
		...
		if (!((_4542_val).Is_None())) && (!((_4544_others).Is_None())) {
			return _dafny.TupleOf(_135_Logic____Option__i_Compile.Option{_135_Logic____Option__i_Compile.Option_Some{(_dafny.SeqOf((_4542_val).Dtor_v().(V))).Concat((_4544_others).Dtor_v().(_dafny.Seq))}}, _4545_rest2)
		} else {
			return _dafny.TupleOf(_135_Logic____Option__i_Compile.Option{_135_Logic____Option__i_Compile.Option_None{}}, _dafny.SeqOf())
		}
	}
...
func (_this *CompanionStruct_Default___) Parse__Array(data _dafny.Seq, eltType G) _System.Tuple2 {
	...
	if !((_4552_len).Is_None()) {
		var _let_tmp_rhs3 _System.Tuple2 = Companion_Default___.Parse__Array__contents(_4553_rest, eltType, ((_4552_len).Dtor_v().(V)).Dtor_u())
		var _ = _let_tmp_rhs3
...
func (_this *CompanionStruct_Default___) Parse__Tuple__contents(data _dafny.Seq, eltTypes _dafny.Seq) _System.Tuple2 {
	if (eltTypes).Equals(_dafny.SeqOf()) {
		...
		var _let_tmp_rhs4 _System.Tuple2 = Companion_Default___.Parse__Val(data, (eltTypes).IndexUint(uint64(0)).(G))
		var _ = _let_tmp_rhs4
		...
		var _ = _4563_rest1
		var _let_tmp_rhs5 _System.Tuple2 = Companion_Default___.Parse__Tuple__contents(_4563_rest1, (eltTypes).Subseq(_dafny.IntOfAny(uint64(1)), _dafny.NilInt))
		var _ = _let_tmp_rhs5
		...
		if (!((_4562_val).Is_None())) && (!((_4564_contents).Is_None())) {
			return _dafny.TupleOf(_135_Logic____Option__i_Compile.Option{_135_Logic____Option__i_Compile.Option_Some{(_dafny.SeqOf((_4562_val).Dtor_v().(V))).Concat((_4564_contents).Dtor_v().(_dafny.Seq))}}, _4565_rest2)
		} else {
			return _dafny.TupleOf(_135_Logic____Option__i_Compile.Option{_135_Logic____Option__i_Compile.Option_None{}}, _dafny.SeqOf())
		}
	}
...
func (_this *CompanionStruct_Default___) ParseTupleContents(data *_dafny.Array, index uint64, eltTypes _dafny.Seq) (bool, _dafny.Seq, uint64) {
	...
	for (_4567_i) < (uint64((eltTypes).CardinalityUint64())) {
		...
		var _out11 uint64
		var _ = _out11
		_out9, _out10, _out11 = Companion_Default___.ParseVal(data, _4568_next__val__index, (eltTypes).IndexUint(_4567_i).(G))
		_4569_some1 = _out9
		_4570_val = _out10
		_4571_rest1 = _out11
		{
...
func (_this *CompanionStruct_Default___) Parse__ByteArray(data _dafny.Seq) _System.Tuple2 {
	...
	var _ = _4578_rest
	if (!((_4577_len).Is_None())) && ((((_4577_len).Dtor_v().(V)).Dtor_u()) <= (uint64((_4578_rest).CardinalityUint64()))) {
		return _dafny.TupleOf(_135_Logic____Option__i_Compile.Option{_135_Logic____Option__i_Compile.Option_Some{V{V_VByteArray{(_4578_rest).Subseq(_dafny.IntOfAny(uint64(0)), _dafny.IntOfAny(((_4577_len).Dtor_v().(V)).Dtor_u()))}}}}, (_4578_rest).Subseq(_dafny.IntOfAny(((_4577_len).Dtor_v().(V)).Dtor_u()), _dafny.NilInt))
	} else {
		return _dafny.TupleOf(_135_Logic____Option__i_Compile.Option{_135_Logic____Option__i_Compile.Option_None{}}, _dafny.SeqOf())
	}
}
...
TAIL_CALL_START:
	...
	if (_4579_some) && (((_4580_len).Dtor_u()) <= ((uint64((data).LenInt(0))) - (func() uint64 { return (_4581_rest) })())) {
		...
		_4582_rest__seq = (data).RangeToSeq(_dafny.IntOfAny(_4581_rest), _dafny.NilInt)
		{
		}
		{
		}
		success = true
		v = V{V_VByteArray{(data).RangeToSeq(_dafny.IntOfAny(_4581_rest), _dafny.IntOfAny((_4581_rest)+((_4580_len).Dtor_u())))}}
...
func (_this *CompanionStruct_Default___) Parse__Case(data _dafny.Seq, cases _dafny.Seq) _System.Tuple2 {
	...
	var _ = _4584_rest1
	if (!((_4583_caseID).Is_None())) && ((((_4583_caseID).Dtor_v().(V)).Dtor_u()) < (uint64((cases).CardinalityUint64()))) {
		var _let_tmp_rhs9 _System.Tuple2 = Companion_Default___.Parse__Val(_4584_rest1, (cases).IndexUint(((_4583_caseID).Dtor_v().(V)).Dtor_u()).(G))
		var _ = _let_tmp_rhs9
		...
		if !((_4585_val).Is_None()) {
			return _dafny.TupleOf(_135_Logic____Option__i_Compile.Option{_135_Logic____Option__i_Compile.Option_Some{V{V_VCase{((_4583_caseID).Dtor_v().(V)).Dtor_u(), (_4585_val).Dtor_v().(V)}}}}, _4586_rest2)
		} else {
			return _dafny.TupleOf(_135_Logic____Option__i_Compile.Option{_135_Logic____Option__i_Compile.Option_None{}}, _dafny.SeqOf())
		}
	} else {
...
func (_this *CompanionStruct_Default___) ParseCase(data *_dafny.Array, index uint64, cases _dafny.Seq) (bool, V, uint64) {
	...
	_4588_caseID = _out19
	_4589_rest1 = _out20
	if (_4587_some1) && (((_4588_caseID).Dtor_u()) < (uint64((cases).CardinalityUint64()))) {
		...
		var _out23 uint64
		var _ = _out23
		_out21, _out22, _out23 = Companion_Default___.ParseVal(data, _4589_rest1, (cases).IndexUint((_4588_caseID).Dtor_u()).(G))
		_4590_some2 = _out21
		_4591_val = _out22
		_4592_rest2 = _out23
		if _4590_some2 {
...
func (_this *CompanionStruct_Default___) Parse__Val(data _dafny.Seq, grammar G) _System.Tuple2 {
	...
	if _source0.Is_GUint64() {
		...
		var _4593_elt G = _source0.Get().(G_GArray).Elt
		var _ = _4593_elt
		return Companion_Default___.Parse__Array(data, _4593_elt)
	} else if _source0.Is_GTuple() {
		var _4594_t _dafny.Seq = _source0.Get().(G_GTuple).T
		var _ = _4594_t
		...
		var _4595_cases _dafny.Seq = _source0.Get().(G_GTaggedUnion).Cases
		var _ = _4595_cases
...
func (_this *CompanionStruct_Default___) ParseVal(data *_dafny.Array, index uint64, grammar G) (bool, V, uint64) {
	...
	if _source1.Is_GUint64() {
		...
		var _4596_elt G = _source1.Get().(G_GArray).Elt
		var _ = _4596_elt
		var _out27 bool
		var _ = _out27
		var _out28 V
		...
		var _4597_t _dafny.Seq = _source1.Get().(G_GTuple).T
		var _ = _4597_t
		var _out30 bool
		var _ = _out30
		var _out31 V
		...
		var _4598_cases _dafny.Seq = _source1.Get().(G_GTaggedUnion).Cases
		var _ = _4598_cases
		var _out36 bool
		var _ = _out36
		var _out37 V
...
func (_this *CompanionStruct_Default___) ComputeSeqSum(s _dafny.Seq) uint64 {
	...
	if (uint64((s).CardinalityUint64())) == (uint64(0)) {
		size = uint64(0)
	} else {
		...
		var _out42 uint64
		var _ = _out42
		_out42 = Companion_Default___.ComputeSizeOf((s).IndexUint(uint64(0)).(V))
...
func (_this *CompanionStruct_Default___) ComputeSizeOf(val V) uint64 {
	...
	if _source2.Is_VUint64() {
		var _4602___v3 uint64 = _source2.Get().(V_VUint64).U
		var _ = _4602___v3
		size = uint64(8)
	} else if _source2.Is_VArray() {
		var _4603_a _dafny.Seq = _source2.Get().(V_VArray).A
		var _ = _4603_a
		var _4604_v uint64
		var _ = _4604_v
		var _out44 uint64
		...
		var _4605_t _dafny.Seq = _source2.Get().(V_VTuple).T
		var _ = _4605_t
		var _out45 uint64
		var _ = _out45
		...
		var _4606_b _dafny.Seq = _source2.Get().(V_VByteArray).B
		var _ = _4606_b
		size = (uint64(8)) + (uint64((_4606_b).CardinalityUint64()))
	} else {
		var _4607_c uint64 = _source2.Get().(V_VCase).C
		var _ = _4607_c
		var _4608_v V = _source2.Get().(V_VCase).Val
		var _ = _4608_v
		var _4609_vs uint64
		var _ = _4609_vs
		var _out46 uint64
...
TAIL_CALL_START:
	...
	var _ = _4610_tuple
	_4610_tuple = Companion_Default___.Parse__Uint64((data).RangeToSeq(_dafny.IntOfAny(index), _dafny.NilInt))
...
func (_this *CompanionStruct_Default___) MarshallArrayContents(contents _dafny.Seq, eltType G, data *_dafny.Array, index uint64) uint64 {
	...
	for (_4611_i) < (uint64((contents).CardinalityUint64())) {
		{
		}
		{
		}
		...
		var _out47 uint64
		var _ = _out47
		_out47 = Companion_Default___.MarshallVal((contents).IndexUint(_4611_i).(V), eltType, data, _4612_cur__index)
...
func (_this *CompanionStruct_Default___) MarshallArray(val V, grammar G, data *_dafny.Array, index uint64) uint64 {
	...
	Companion_Default___.MarshallUint64(uint64(((val).Dtor_a()).CardinalityUint64()), data, index)
	{
	}
	{
	}
...
func (_this *CompanionStruct_Default___) MarshallTupleContents(contents _dafny.Seq, eltTypes _dafny.Seq, data *_dafny.Array, index uint64) uint64 {
	...
	for (_4615_i) < (uint64((contents).CardinalityUint64())) {
		{
		}
		{
		}
		...
		var _out49 uint64
		var _ = _out49
		_out49 = Companion_Default___.MarshallVal((contents).IndexUint(_4615_i).(V), (eltTypes).IndexUint(_4615_i).(G), data, _4616_cur__index)
...
func (_this *CompanionStruct_Default___) MarshallBytes(bytes _dafny.Seq, data *_dafny.Array, index uint64) {
	goto TAIL_CALL_START
TAIL_CALL_START:
	// TONY: Following line is commented out because not sure if called. If it is, fix it
	// _9_Native____Io__s_Compile.Companion_Arrays_.CopySeqIntoArray(bytes, uint64(0), data, index, uint64((bytes).CardinalityUint64()))
	_9_Native____Io__s_Compile.TraceAndExit()
}
func (_this *CompanionStruct_Default___) MarshallByteArray(val V, grammar G, data *_dafny.Array, index uint64) uint64 {
	var size uint64 = 0
	var _ = size
	Companion_Default___.MarshallUint64(uint64(((val).Dtor_b()).CardinalityUint64()), data, index)
	{
	}
	...
	size = (uint64(8)) + (uint64(((val).Dtor_b()).CardinalityUint64()))
	return size
}
func (_this *CompanionStruct_Default___) MarshallCase(val V, grammar G, data *_dafny.Array, index uint64) uint64 {
	...
	var _out51 uint64
	var _ = _out51
	_out51 = Companion_Default___.MarshallVal((val).Dtor_val(), ((grammar).Dtor_cases()).IndexUint((val).Dtor_c()).(G), data, (index)+(uint64(8)))
...
func (_this *CompanionStruct_Default___) MarshallVal(val V, grammar G, data *_dafny.Array, index uint64) uint64 {
	...
	if _source3.Is_VUint64() {
		var _4619___v4 uint64 = _source3.Get().(V_VUint64).U
		var _ = _4619___v4
		var _out52 uint64
		var _ = _out52
		...
		var _4620___v5 _dafny.Seq = _source3.Get().(V_VArray).A
		var _ = _4620___v5
		var _out53 uint64
		var _ = _out53
		...
		var _4621___v6 _dafny.Seq = _source3.Get().(V_VTuple).T
		var _ = _4621___v6
		var _out54 uint64
		var _ = _out54
		...
		var _4622___v7 _dafny.Seq = _source3.Get().(V_VByteArray).B
		var _ = _4622___v7
		var _out55 uint64
		var _ = _out55
		...
		var _4623___v8 uint64 = _source3.Get().(V_VCase).C
		var _ = _4623___v8
		var _4624___v9 V = _source3.Get().(V_VCase).Val
		var _ = _4624___v9
		var _out56 uint64
		var _ = _out56
...
TAIL_CALL_START:
	...
	_4625_size = _out57
	var _nw5 = _dafny.NewArrayWithValue(0, _dafny.IntOfAny(_4625_size))
	var _ = _nw5
	data = _nw5
