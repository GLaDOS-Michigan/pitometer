...
func (_this CAppMessage) String() string {
	...
	case CAppMessage_CAppIncrement:
		{
			return "CAppMessage.CAppIncrement"
		}
	case CAppMessage_CAppReply:
		{
			return "CAppMessage.CAppReply" + "(" + _dafny.String(data.Response) + ")"
		}
	case CAppMessage_CAppInvalid:
		{
			return "CAppMessage.CAppInvalid"
		}
	default:
		{
			return "<unexpected>"
...
func (_this *CompanionStruct_Default___) ValidAppMessage(c CAppMessage) bool {
	return true
}
...
func (_this *CompanionStruct_Default___) Parse__AppMessage(val _176_Common____GenericMarshalling__i_Compile.V) CAppMessage {
...
func (_this *CompanionStruct_Default___) MarshallCAppMessage(c CAppMessage) _176_Common____GenericMarshalling__i_Compile.V {
	goto TAIL_CALL_START
TAIL_CALL_START:
	var val _176_Common____GenericMarshalling__i_Compile.V = _176_Common____GenericMarshalling__i_Compile.Type_V_().Default().(_176_Common____GenericMarshalling__i_Compile.V)
	var _ = val
	var _source4 CAppMessage = c
	var _ = _source4
	if _source4.Is_CAppIncrement() {
		...
		var _4638_response uint64 = _source4.Get().(CAppMessage_CAppReply).Response
...
func (_this *CompanionStruct_Default___) HandleAppRequest(appState uint64, request CAppMessage) (uint64, CAppMessage) {
	goto TAIL_CALL_START
TAIL_CALL_START:
	var appState_k uint64 = 0
	var _ = appState_k
	var reply CAppMessage = Type_CAppMessage_().Default().(CAppMessage)
	var _ = reply
