...
case ReceiveResult_RRFail: {
      return "_368_LiveRSL____UdpRSL__i_Compile.ReceiveResult.RRFail"
    }
    case ReceiveResult_RRTimeout: {
      return "_368_LiveRSL____UdpRSL__i_Compile.ReceiveResult.RRTimeout"
    }
    case ReceiveResult_RRPacket: {
      return "_368_LiveRSL____UdpRSL__i_Compile.ReceiveResult.RRPacket" + "(" + _dafny.String(data.Cpacket) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this type_ReceiveResult_) String() string {
  return "_368_LiveRSL____UdpRSL__i_Compile.ReceiveResult"
}
...
func (*Default__) String() string {
  return "_368_LiveRSL____UdpRSL__i_Compile.Default__"
}
...
func (_this *CompanionStruct_Default___) Receive(udpClient *_9_Native____Io__s_Compile.UdpClient, localAddr _9_Native____Io__s_Compile.EndPoint, config _238_LiveRSL____CPaxosConfiguration__i_Compile.CPaxosConfiguration, msg__grammar _176_Common____GenericMarshalling__i_Compile.G) _368_LiveRSL____UdpRSL__i_Compile.ReceiveResult {
  var rr _368_LiveRSL____UdpRSL__i_Compile.ReceiveResult = Type_ReceiveResult_().Default().(_368_LiveRSL____UdpRSL__i_Compile.ReceiveResult)
  var _ = rr
...
_5212_buffer = _out387
    ...
    var _ = _5213_i
    _5213_i = uint64(0)
    for (_5213_i) < (uint64(((broadcast).Dtor_dsts()).CardinalityInt())) {
      { }
      var _5214_dstEp _9_Native____Io__s_Compile.EndPoint
      var _ = _5214_dstEp
      _5214_dstEp = ((broadcast).Dtor_dsts()).Index(_5213_i).(_9_Native____Io__s_Compile.EndPoint)
...
func (_this *CompanionStruct_Default___) SendPacketSequence(udpClient *_9_Native____Io__s_Compile.UdpClient, packets _217_LiveRSL____CMessage__i_Compile.OutboundPackets) bool {
  ...
  var _ = _5228_i
  _5228_i = uint64(0)
  for (_5228_i) < (uint64((_5226_cpackets).CardinalityInt())) {
    var _5229_cpacket _217_LiveRSL____CMessage__i_Compile.CPacket
    var _ = _5229_cpacket
    _5229_cpacket = (_5226_cpackets).Index(_5228_i).(_217_LiveRSL____CMessage__i_Compile.CPacket)
