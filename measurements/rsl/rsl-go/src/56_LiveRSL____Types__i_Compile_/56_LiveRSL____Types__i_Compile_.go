...
func (CompanionStruct_Request_) Create_Request_(Client _9_Native____Io__s_Compile.EndPoint, Seqno _dafny.Int, r _50_AppStateMachine__i_Compile.AppMessage_k) Request {
	return Request{Request_Request{Client, Seqno, r}}
}
...
func (CompanionStruct_Vote_) Create_Vote_(Max__value__bal Ballot) Vote {
...
func (_this Vote) Dtor_max__value__bal() Ballot {
	return _this.Get().(Vote_Vote).Ballot
}
...
func (_this Vote) String() string {
	...
	case Vote_Vote:
		{
			return "_56_LiveRSL____Types__i_Compile.Vote.Vote" + "(" + _dafny.String(data.Ballot) + ")"
		}
	default:
		{
			return "<unexpected>"
	...
	case Vote_Vote:
		{
			...
			return ok && data1.Ballot.Equals(data2.Ballot)
		}
	default:
		{
			return false // unexpected
...
func (_this type_Vote_) Default() interface{} {
	return Vote{Vote_Vote{Type_Ballot_().Default().(Ballot)}}
}
