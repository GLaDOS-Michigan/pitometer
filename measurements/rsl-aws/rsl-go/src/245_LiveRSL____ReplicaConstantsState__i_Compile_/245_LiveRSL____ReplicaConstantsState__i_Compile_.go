...
func (_this *CompanionStruct_Default___) InitReplicaConstantsState(endPoint _9_Native____Io__s_Compile.EndPoint, config _238_LiveRSL____CPaxosConfiguration__i_Compile.CPaxosConfiguration) ReplicaConstantsState {
	goto TAIL_CALL_START
TAIL_CALL_START:
	var rc ReplicaConstantsState = Type_ReplicaConstantsState_().Default().(ReplicaConstantsState)
	var _ = rc
