// Package _577_CommonProof____Chosen__i_Compile
// Dafny module _577_CommonProof____Chosen__i_Compile compiled into Go
...
// Definition of data type QuorumOf2bs
type QuorumOf2bs struct {
  Data_QuorumOf2bs_
}

func (_this QuorumOf2bs) Get() Data_QuorumOf2bs_ {
  return _this.Data_QuorumOf2bs_
}

type Data_QuorumOf2bs_ interface {
  isQuorumOf2bs()
}

type CompanionStruct_QuorumOf2bs_ struct {}
var Companion_QuorumOf2bs_ = CompanionStruct_QuorumOf2bs_{}

type QuorumOf2bs_QuorumOf2bs struct {
  C _78_LiveRSL____Constants__i_Compile.LConstants
Indices _dafny.Set
Packets _dafny.Seq
...
func (QuorumOf2bs_QuorumOf2bs) isQuorumOf2bs() {}

func (CompanionStruct_QuorumOf2bs_) Create_QuorumOf2bs_(C _78_LiveRSL____Constants__i_Compile.LConstants, Indices _dafny.Set, Packets _dafny.Seq, Bal _56_LiveRSL____Types__i_Compile.Ballot, Opn _dafny.Int, V _dafny.Seq) QuorumOf2bs {
  return QuorumOf2bs{QuorumOf2bs_QuorumOf2bs{C,Indices,Packets,Bal,Opn,V}}
}

func (_this QuorumOf2bs) Is_QuorumOf2bs() bool {
  _, ok := _this.Get().(QuorumOf2bs_QuorumOf2bs)
return ok
}

func (_this QuorumOf2bs) Dtor_c() _78_LiveRSL____Constants__i_Compile.LConstants {
  return _this.Get().(QuorumOf2bs_QuorumOf2bs).C
}

func (_this QuorumOf2bs) Dtor_indices() _dafny.Set {
  return _this.Get().(QuorumOf2bs_QuorumOf2bs).Indices
}

func (_this QuorumOf2bs) Dtor_packets() _dafny.Seq {
  return _this.Get().(QuorumOf2bs_QuorumOf2bs).Packets
}

func (_this QuorumOf2bs) Dtor_bal() _56_LiveRSL____Types__i_Compile.Ballot {
  return _this.Get().(QuorumOf2bs_QuorumOf2bs).Bal
}

func (_this QuorumOf2bs) Dtor_opn() _dafny.Int {
  return _this.Get().(QuorumOf2bs_QuorumOf2bs).Opn
}

func (_this QuorumOf2bs) Dtor_v() _dafny.Seq {
  return _this.Get().(QuorumOf2bs_QuorumOf2bs).V
}

func (_this QuorumOf2bs) String() string {
  switch data := _this.Get().(type) {
    case nil: return "null"
case QuorumOf2bs_QuorumOf2bs: {
      return "_577_CommonProof____Chosen__i_Compile.QuorumOf2bs.QuorumOf2bs" + "(" + _dafny.String(data.C) + ", " + _dafny.String(data.Indices) + ", " + _dafny.String(data.Packets) + ", " + _dafny.String(data.Bal) + ", " + _dafny.String(data.Opn) + ", " + _dafny.String(data.V) + ")"
    }
    default: {
      return "<unexpected>"
    }
...
func (_this QuorumOf2bs) Equals(other QuorumOf2bs) bool {
  switch data1 := _this.Get().(type) {
    case QuorumOf2bs_QuorumOf2bs: {
      data2, ok := other.Get().(QuorumOf2bs_QuorumOf2bs)
return ok && data1.C.Equals(data2.C) && data1.Indices.Equals(data2.Indices) && data1.Packets.Equals(data2.Packets) && data1.Bal.Equals(data2.Bal) && data1.Opn.Cmp(data2.Opn) == 0 && data1.V.Equals(data2.V)
    }
    default: {
...
func (_this QuorumOf2bs) EqualsGeneric(other interface{}) bool {
  typed, ok := other.(QuorumOf2bs)
return ok && _this.Equals(typed)
}
func Type_QuorumOf2bs_() _dafny.Type {
  return type_QuorumOf2bs_{}
}

type type_QuorumOf2bs_ struct {
}

func (_this type_QuorumOf2bs_) Default() interface{} {
  return QuorumOf2bs{QuorumOf2bs_QuorumOf2bs{_78_LiveRSL____Constants__i_Compile.Type_LConstants_().Default().(_78_LiveRSL____Constants__i_Compile.LConstants), _dafny.EmptySet, _dafny.EmptySeq, _56_LiveRSL____Types__i_Compile.Type_Ballot_().Default().(_56_LiveRSL____Types__i_Compile.Ballot), _dafny.Zero, _dafny.EmptySeq}}
}

func (_this type_QuorumOf2bs_) String() string {
  return "_577_CommonProof____Chosen__i_Compile.QuorumOf2bs"
}
// End of data type QuorumOf2bs
